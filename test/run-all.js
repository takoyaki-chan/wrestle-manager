...
const QUICK = new Set([
  ...
  'event-popup-speech-semantics-test.js',
  ...
  'growth-frac-carry-test.js',
  'growth-lifecycle-test.js',
  ...
  'rental-save-roundtrip-test.js',
  'retain-fighter-test.js',
  'rivalry-resolution-regression-test.js',
  'rivalry-resolution-match-guard-test.js',
  ...
  'title-match-ceremony-test.js',
  'title-defense-count-test.js',
  'title-portrait-marquee-test.js',
  'trait-mojibake-repair-test.js',
