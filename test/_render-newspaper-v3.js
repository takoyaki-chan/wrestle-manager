...
const issue = {
  ...
  topStory: {
    ...
    body: '第14週興行のメインイベントで阿武隈塔子が相沢みなみを破り、団体王座を獲得した。試合時間18分42秒、最後は正面からの組み技で3カウント。初挑戦で敗れてから3年、7度目の対戦で初めてベルトが腰に巻かれた。序盤は王者のペースだった。相沢の打撃が阿武隈の出足を止め、場内には嫌な沈黙が流れる。だが中盤、阿武隈は被弾を覚悟で距離を詰め、試合の重心を組みに引きずり込んだ。通算成績はなお相沢の4勝3敗。数字の上では王者だった側が上回る。それでも今夜の歓声は、この3年間を見続けた者への報酬だった。防衛戦線は来月から始まる。新王者に休む間はない。',
  },
  subStories: [
