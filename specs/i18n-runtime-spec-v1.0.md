...
### 39-2. JA同一性は「見えている行」で測る — `display:none` の要素の `innerText` は罠
...
### 39-3. 文字数で見た目を切り替える判定は言語別化する(§31-4 の2例目)
...
### 39-4. 単体の `const NAME = '…'` は3つの抽出器のどれからも見えない
...
### 39-5. 「未カバー」の中には**訳してはいけないもの**が3種混ざる
