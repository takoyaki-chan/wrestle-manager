...
- **MVPレース**: UNIFIED_DEFENSE **+13**・UNIFIED_CAPTURE **+13**(対称)・年末保持 **+12**・won +0
  - **2026-09-17 再較正(20→13)**: アンケート要望「MVPが統一王者の条件みたいになっている」を受けて実測 → v1(20/20/12)は**MVPの79.5%が統一王座絡み**(季内に統一戦勝利 or 年末保持・2シード140季・通常年PPV合成)。統一戦の1勝を**団体王座防衛(13)と同格**へ。統一戦線フル稼働の1年(13×4+12=64)が団体王座を守り抜いた1年(11+13×4+8=71)を超えない — ベルトの格は殿堂pt・人気・動員が背負い、MVPは「その年の働き」を測る
  - 実測(v1→v2): MVPの統一絡み率 79.5%→74.2% / 統一に絡まない選手の当たり年がMVPを守れる率 42%→53%。**統一ptを全廃しても床は51.5%**(統一戦線に居るのは元々最強格)=配点だけで動かせる幅は狭い。非エースのMVPルート拡充は別課題(roadmap)
  - 不変条件(`test/unified-title-p4-test.js`): 奪取=防衛 / 統一戦1勝≥団体王座防衛 / 年末保持≥団体王座の年末保持 / 統一フル稼働年≤団体王座フル稼働年
  - 較正器: `node tools/mvp-race-calibration.js record|grid`(同一状態に配点だけ差し替える受動ペアプローブ)
  - 旧記録(導入時・指標は「年末王者か」): MVP中の統一王者比率38%→56%(較正条項9割は未発動)、殿堂★★★ 45→50(2倍条項未発動)
