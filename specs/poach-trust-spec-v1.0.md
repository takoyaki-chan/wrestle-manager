...
- [ ] A-1: trust 補正が C-2 に組み込まれ、年間オファー率が trust 帯で明確に変動する
- [ ] A-2: 防衛率が trust 帯で変動する
- [ ] B-1: 週次空気ログが低 trust 時に発火し、gameLog に表示される
- [ ] B-2: 四半期末前週に予兆通知が出て、リスク選手が名指しで警告される
- [ ] セーブ互換性が保たれている（旧セーブで新版を起動しても破損しない）
- [ ] 既存の pendingNotifEvent / pendingChoiceEvent と衝突しない
