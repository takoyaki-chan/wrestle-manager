...
- シーズン開幕処理で付与判定:
  ...
  - B級: なし
- 推奨フィルタ: 候補は ageMul > 0(成長年齢内)の選手に限る — 成長停止選手への付与は効果ゼロの空振りになるため。フィルタ後の候補が3名未満なら残った候補から選出
...
2. **P-5の付与確率**(S 50% / elevated A 30%)と ageMulフィルタの採否 — 対象選出は「trainCap上位3からランダム」で確定済み(2026-08-01)
