> ⚠️ **この文書は 2026-08-02 に `specs/newspaper-spec-v1.0.md` へ置き換えられた。**
> 新聞の紙面構成・採点・特集の発火条件・写真・文字のルールは**すべて v1.0 が正**。
> ここに残しているのは、業界ニュースキューの type 一覧や個別イベントの経緯など、
> v1.0 が要約しか持たない細目のため。**矛盾したら v1.0 を優先すること。**
