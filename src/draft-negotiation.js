...
Engine.draftNegotiation = {
  ...
  NARRATION: {
    ...
    playerWin: {
      solo: ['契約成立。静かに迎え入れる', '他に名乗りを上げる者はなかった。交渉成立'],
      vs1: [
        '一騎打ちを制した',
        '激しい交渉を勝ち抜いた',
        '粘り強い交渉が実を結んだ',
      ...
      multi: [
        '複数団体との争奪戦を勝ち抜いた！',
        '激戦の末、獲得に成功！',
        '3団体を退けての獲得。この選手にかけた執念が勝った',
      ],
    },
    playerLost: [
      '他団体に持っていかれた。次の機会を待とう',
      '残念…他団体の執念が上回った',
      '相手の本気度が一枚上手だった。縁がなかったと割り切るしかない',
    ],
    flowThrough: [
      '全団体が手を引いた。この選手はフリー市場へ',
      '誰も最後まで残らなかった。フリーエージェントとして再出発',
    ],
    roundStart: [
      '交渉卓に緊張が走る',
      '各団体の代表が表情を引き締める',
