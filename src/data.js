...
const ALL_CHARS = [
  ...
  {id:4,name:'高津小春',h:161,pw:73,sp:75,te:47,st:79,mn:91,style:'Striker',role:'Babyface',pot:{pw:155,sp:158,te:155,st:163,mn:178},traits:['晩成','番狂わせ体質','負けず嫌い','闘志','反骨心'],personality:'emotional',archetype:'normal'},
...
const RIVALRY_CONFRONTATION_LINES = {
  // 通常因縁（rivalry 50-69相当）— attacker: 挑戦的 / defender: 受けて立つ
  attacker: {
    normal: {
      _default: ['今日こそ、決着をつける', 'この因縁、今夜終わりにしましょう', 'あなたを超える。今日、ここで'],
      ojousama: ['今宵、決着をつけさせていただきますわ', 'あなたを超えますわ。今日、ここで'],
      delinquent: ['今日で終わりだ。覚悟しろ', 'ぶっ倒してやるよ、今夜な'],
      cool: ['……決着をつける'],
      seductive: ['今夜、終わりにしましょう？', 'あなたを超えてみせるわ'],
    },
    bold: {
      _default: ['逃がさないよ。今日ここで決着をつける', '何度やっても結果は同じ。かかってきなさい'],
      ojousama: ['逃がしませんわ。今日ここで決着ですの'],
      delinquent: ['逃がさねえぞ。今日で終わりだ'],
      cool: ['……来い。終わらせる'],
      seductive: ['逃がさないわよ。今日で決着よ'],
    },
    quiet: {
      _default: ['………（静かに構える）'],
      cool: ['……今日、決める'],
      polite: ['…今日で…決着をつけさせてください'],
    },
    shy: { _default: ['えっと…今日は…その…負けたくないんです…'] },
    easygoing: {
      _default: ['さーて、今日で決着つけようか！', 'そろそろケリつけようよ！'],
      delinquent: ['よっしゃ、今日で終わりにしようぜ！'],
    },
    earnest: {
      _default: ['今日こそ決着をつけます', 'この因縁に、終止符を打ちます'],
      polite: ['本日、決着をつけさせていただきます'],
      ojousama: ['今日こそ決着ですわ'],
    },
    emotional: { _default: ['今日で……終わりにする……！ 絶対に……！'] },
  },
  defender: {
    normal: {
      _default: ['……望むところよ', 'それは終わってから言いなさい', '超えられるものなら、やってみなさい'],
      ojousama: ['……望むところですわ', 'やれるものならやってごらんなさい'],
      delinquent: ['上等だ。来いよ', 'やれるもんならやってみな'],
      cool: ['……来い'],
      seductive: ['望むところよ。全力で来なさい'],
    },
    bold: {
      _default: ['いいよ、来なさい。全力で迎え撃つ', '何度来ても返り討ちにしてあげる'],
      ojousama: ['全力でお迎えしますわ'],
      delinquent: ['返り討ちにしてやるぜ'],
      cool: ['……受けて立つ'],
    },
    quiet: {
      _default: ['………（静かに頷く）'],
    ...
    shy: { _default: ['…受けます。…頑張ります…'] },
    easygoing: {
      _default: ['いいよ、来なよ！ 全力で相手してあげる！'],
      delinquent: ['おう、来いよ！'],
    },
    earnest: {
      _default: ['受けて立ちます。全力で', '最後にふさわしい試合にしましょう'],
      polite: ['お受けいたします。全力で参ります'],
    },
    emotional: { _default: ['来なさい……！ 全部受け止めてやる……！'] },
  },
  // 宿命の相手（旧fatePairs）— より重みのある、物語の集大成
  fateAttacker: {
    normal: {
      _default: ['長かった……この物語に、終止符を打つ', 'あなたがいなければ、今の私はいない。でも今日で終わりだ'],
      ojousama: ['長い物語でしたわ……今宵、終止符を打ちますの'],
      delinquent: ['長かったな……今日で終わりだ'],
      cool: ['……終わらせに来た'],
      seductive: ['長い物語だったわね。今夜、最後のページよ'],
    },
    bold: {
      _default: ['何度も戦ってきた。でも今日が最後よ', '始めましょう。この物語の続きを'],
      cool: ['……最後だ。全てを出す'],
    },
    quiet: { _default: ['………（深く息を吸い、一歩前に出る）'] },
    shy: { _default: ['ずっと…この日のことを考えてました…行きます…'] },
    easygoing: { _default: ['最後の一戦だ。全部出し切ろう！'] },
    earnest: { _default: ['この物語に、終止符を打ちます。全力で'] },
    emotional: { _default: ['ずっと……ずっとこの日を……！'] },
  },
  fateDefender: {
    normal: {
      _default: ['ええ……最高の結末を見せましょう', '……お互い様よ。だから今日も全力で'],
      ojousama: ['最高の結末を見せて差し上げますわ'],
      delinquent: ['ああ。最高の終わりにしようぜ'],
      cool: ['……わかっている'],
      seductive: ['最高の結末にしましょう'],
    },
    bold: {
      _default: ['わかってる。だから全力でいらっしゃい', 'ふさわしい戦いにしましょう'],
      cool: ['……全力で来い'],
    },
    quiet: { _default: ['………（小さく微笑み、構える）'] },
    shy: { _default: ['…うん…わかってる…。行こう…'] },
    easygoing: { _default: ['おう！ 最高のフィナーレにしようぜ！'] },
    earnest: { _default: ['全力でお受けします。悔いのない試合を'] },
    emotional: { _default: ['来なさい……！ 全部……受け止める……！'] },
  },
};
...
const RIVALRY_RESOLUTION_LINES = {
  winner: {
    normal: {
      _default: ['一つ、決着がついた…でもまだ終わりじゃない気がする', '勝てた…けど、この人との関係はここからだと思う'],
      ojousama: ['一つ決着がつきましたわ…でも、まだ終わった気がしませんの'],
      delinquent: ['ひとまず決着だ…でも、なんだろ。まだモヤモヤすんな'],
      seductive: ['ひとつ片がついたわ…でも、まだあなたから目が離せないの'],
    },
    bold: {
      _default: ['一つ勝った。でもこの程度じゃ終わらないでしょ？', '今日は私の拳が届いた。…次はどうなるかわからないけど'],
      ojousama: ['ひとまず勝たせていただきましたわ。…でも、これで満足はしませんの'],
      delinquent: ['一個返したぞ。…でもまだ足りねえ気がすんだよ'],
      cool: ['…一つ片がついた。…まだ先がある'],
      seductive: ['今日は私の勝ち。…でも、まだ飽きてないわよ？'],
    },
    quiet: {
      _default: ['………一つ、終わった（でもまだ、目が離せない）'],
      cool: ['…一区切り。…でも、終わった気はしない'],
      polite: ['…ひとまず…決着です…でも…'],
    },
    shy: { _default: ['か、勝てた…けど…なんだろ…終わった気がしない…'] },
    easygoing: {
      _default: ['よっしゃ一個勝ち！ …でもさ、まだ続きがありそうだよね'],
      delinquent: ['いよっしゃ！ …でもよ、なんかまだスッキリしねえんだよな'],
      seductive: ['勝っちゃった〜。…でもね、まだあなたとは決着ついてない気がするの'],
    },
    earnest: {
      _default: ['一つ決着がつきました。…でも、この関係はまだ続く気がします', '勝ちました…けど、ここからがこの因縁の本番だと思っています'],
      polite: ['ひとまず決着です…でも、この先にもっと大きな何かがある気がするんです'],
      ojousama: ['ひとつ結果を出しましたわ…でも、まだ終わりではありませんわね'],
      seductive: ['一つ勝ったわ。…でも、これで終わりとは思えないの'],
    },
    emotional: { _default: ['勝った…！でも…なんで涙が止まらないの…まだ終わってないのに…！'] },
  },
  loser: {
    normal: {
      _default: ['負けた…悔しい。でも、これで終わりなんかじゃない', '悔しい。今日は負けた。…でも、次がある。絶対に'],
      ojousama: ['負けましたわ…でも、これで幕引きとは思っておりませんの'],
      delinquent: ['くそっ…負けた。…でもこれで終わりだと思うなよ'],
      seductive: ['負けたわ…でも、まだあなたとの物語は続くのよ'],
    },
    bold: {
      _default: ['今日は完敗。…でも、ここから巻き返す。見てなさい', 'この借りは必ず返す。…次こそは'],
      ojousama: ['今日は完敗ですわ。…ですが、次がありましてよ'],
      delinquent: ['くっそ…完敗だ。…だがこの借りは絶対返すからな'],
      cool: ['…認める。…だが、次がある'],
      seductive: ['完敗ね…でも、次は私の番よ。覚えておきなさい'],
    },
    quiet: {
      _default: ['………（拳を握りしめ、相手の背中を見ている）'],
      cool: ['…今日は負けた。…次だ'],
      polite: ['…負けました。…でも…次は、必ず…'],
    },
    shy: { _default: ['…負けちゃった…悔しい…でも…次こそは…絶対…'] },
    easygoing: {
      _default: ['負けた〜…くやし〜！ でもまだ続くよね？ 次は負けないから！'],
      delinquent: ['ちくしょ〜…負けた！ でもよ、次は絶対やり返すからな！'],
      seductive: ['負けちゃったわ〜…でもね、次は覚悟しておいてね？'],
    },
    earnest: {
      _default: ['負けました…でも、この因縁はまだ続きます。必ず借りを返します', '悔しいです。…でも、この悔しさが次の力になると信じています'],
      polite: ['負けました…でも、次の機会に必ず結果を出してみせます'],
      ojousama: ['負けましたわ…ですが、この借りは必ずお返ししますわ'],
      seductive: ['負けたわ…でも、この悔しさがあるから次がある。そう思うの'],
    },
    emotional: { _default: ['悔しい…！悔しい…！ でも…絶対…次は…負けない…！'] },
  },
  fateWinner: {
    normal: {
      _default: ['ずっと追いかけてきた答えが…一つ、出た。…でもまだ、この人とのことは終わらない'],
      ojousama: ['ようやく…一つの答えが出ましたわ。…でも、終わりではありませんの'],
      delinquent: ['やっと…一つ決着がついた…でもよ、なんかまだ胸がざわつくんだ'],
      seductive: ['ようやく一つ答えが出たわ…でも、あなたとの物語はまだ途中よ'],
    },
    bold: {
      _default: ['長い戦いだった。一つ勝った…でも、まだ先がある。そうでしょ？', '一つの章が終わった。…でもこの物語に最終章なんてない'],
      cool: ['…一つ決着がついた。…だが、まだ先がある'],
    },
    quiet: { _default: ['………（深く息を吐く。目は、まだ相手を追っている）'] },
    shy: { _default: ['勝った…のかな…でも…終わった気がしない…（涙が溢れている）'] },
    easygoing: { _default: ['やっと一つ勝てた…！ でもさ、まだこの人との話、続くよね…？'] },
    earnest: { _default: ['長い戦いでした…一つの答えは出た。でも、この人との関係はここからだと思います'] },
    emotional: { _default: ['勝った…！やっと…！ でも…まだ泣きたくない…まだ続くから…！（涙）'] },
  },
  fateLoser: {
    normal: {
      _default: ['今日は…敵わなかった。でも、この悔しさが次の私を作る'],
      ojousama: ['今日は敵いませんでしたわ…でも、これで終わりではありませんの'],
      delinquent: ['くそっ…敵わなかった。…でもよ、まだ終わってねえぞ'],
      seductive: ['敵わなかったわ…でも、これで終わりなんて思わないでね'],
    },
    bold: {
      _default: ['まだ負けっぱなしじゃ終われない。…必ず超えてみせる', '全力で負けた。…だからこそ、次が欲しい。絶対に'],
      cool: ['…全力で届かなかった。…だからこそ、次だ'],
    },
    quiet: { _default: ['………（唇を噛んで、静かに立ち上がる）'] },
    shy: { _default: ['…負けちゃった…でも…まだ…諦めたくない…です…（涙を拭いている）'] },
    easygoing: { _default: ['負けた〜…まいったな。…でもさ、次があるでしょ？ ね？'] },
    earnest: { _default: ['負けました。…でも、この悔しさを糧にまた挑みます。必ず'] },
    emotional: { _default: ['悔しい…！でも…ここで終わるもんか…！ 絶対また…！（涙）'] },
  },
};
...
const GOODRIVAL_RESOLUTION_LINES = {
  winner: {
    ...
    bold: {
      _default: ['あなたは私の誇り。これからも全力で来なさい', '最高の好敵手よ。胸を張って'],
    ...
    shy: { _default: ['あの…あなたがいてくれたから…私、ここまで来れたんです…（おずおずと手を差し出す）'] },
    easygoing: {
  ...
  loser: {
    ...
    bold: {
      _default: ['完敗ね。でも悔いはない。最高の好敵手だった', '負けた。けど胸を張って言える——あなたは最高のライバルよ'],
      cool: ['……負けた。だが……悪くない'],
    },
    quiet: {
      _default: ['………（涙を拭い、静かに笑う）'],
    ...
    shy: { _default: ['負けちゃった…でも…この人とまた戦えるなら…それでいいかな…（涙）'] },
    easygoing: {
...
const BITTER_RESOLUTION_LINES = {
  winner: {
    normal: {
      _default: ['……終わった。もう二度と、あなたの顔は見たくない', '決着はついた。これで終わりにしましょう'],
    ...
    bold: {
      _default: ['終わったわ。これが私の答え', 'ようやく決着がついた。もう振り返らない'],
    ...
    shy: { _default: ['…もう関わりたくない…です…（震えが止まらない）'] },
    easygoing: {
  ...
  loser: {
    normal: {
      _default: ['……認めない。こんなの認めない', '負けた？ ……覚えておきなさい！'],
    ...
    bold: {
      _default: ['認めない。…この借りは必ず返す', '……もう一度。もう一度やらせて……！'],
...
const RIVALRY_CONFRONTATION_LINES_70 = {
  // rivalry 70〜89: 宿命の対決 — 通常版より激しい
  attacker: {
    normal: {
      _default: ['逃げ場はない。ここで全てを終わらせる', 'あなたの存在が、私を追い詰めてきた。今夜それを終わらせる', 'この因縁に、終止符を打つ'],
      ojousama: ['もう逃がしませんわ。ここで全て終わりにしますの'],
      delinquent: ['逃げ場はねえ。ここで終わりだ', 'てめえとの因縁、今夜ぶった斬る'],
      cool: ['……逃がさない。終わらせる'],
      seductive: ['もう逃げられないわよ。ここで終わりにしましょう'],
    },
    bold: {
      _default: ['どれだけこの瞬間を待ったか。今日、超えてみせる', 'もう後はない。ここで決める'],
      ojousama: ['何度夢に見たことでしょう。この瞬間を'],
      delinquent: ['ずっと待ってたんだ、この瞬間を'],
      cool: ['……待った。この日を'],
    },
    quiet: {
      _default: ['………（鋭い眼光で相手を見据える）'],
      cool: ['……ここで、終わる'],
    },
    shy: { _default: ['…怖いけど…ここで逃げたら自分を許せない…'] },
    easygoing: {
      _default: ['いよいよだね。全部出し切るよ！'],
      delinquent: ['いよいよだな。全力で行くぜ！'],
    },
    earnest: {
      _default: ['ここで全てを終わらせます。覚悟してください', 'この因縁に、終止符を打ちます'],
      polite: ['本日こそ、決着をつけさせていただきます'],
    },
    emotional: { _default: ['もう……もう限界だ……今日で全部終わらせる……！'] },
  },
  defender: {
    normal: {
      _default: ['……来なさい。全力で迎え撃つ', 'なら証明してみせなさい。あなたが上だと', '打てるものなら、打ってみなさい'],
      ojousama: ['いらっしゃい。全力でお迎えしますわ'],
      delinquent: ['来いよ。返り討ちにしてやる', '打てるもんなら打ってみろ'],
      cool: ['……来い。迎え撃つ'],
      seductive: ['いいわよ。全力で迎えてあげる'],
    },
    bold: {
      _default: ['……同感ね。だから本気で行くよ', '夢のままで終わらせてあげる'],
      ojousama: ['同感ですわ。本気で参りますの'],
      delinquent: ['ああ、本気で潰しに行く'],
      cool: ['……同感だ'],
    },
    quiet: {
      _default: ['………（静かに、しかし確かに構える）'],
      cool: ['……来い'],
    },
    shy: { _default: ['…わかりました。…全部、受け止めます…'] },
    easygoing: {
      _default: ['おっけー。こっちも全力だよ！'],
      delinquent: ['おう、来いよ！ 全力だ！'],
    },
    earnest: {
      _default: ['お受けします。全身全霊で'],
      polite: ['全力でお相手させていただきます'],
    },
    emotional: { _default: ['来なさい……！ 全力で……迎え撃つ……！'] },
  },
};
const RIVALRY_CONFRONTATION_LINES_90 = {
  // rivalry 90〜100: 最上位 — 言葉少なで重い
  attacker: {
    normal: {
      _default: ['……この日をどれだけ待ったか', 'あなたを超えなければ、私の物語は終わらない'],
      ojousama: ['この日をどれほどお待ちしたことか……'],
      delinquent: ['……ずっと待ってた。この日を'],
      cool: ['……来た。この日が'],
      seductive: ['……ようやく、この日が来たわね'],
    },
    bold: {
      _default: ['全部賭ける。残らず全部', '……行くよ。最後の戦い'],
      cool: ['……全てを賭ける'],
    },
    quiet: {
      _default: ['………（言葉はない。ただ、眼差しだけが全てを語る）'],
      cool: ['………'],
    },
    shy: { _default: ['………もう何も言わない。…行きます'] },
    easygoing: { _default: ['……全部、出し切る。今日で'] },
    earnest: { _default: ['全てを賭けます。この一戦に'] },
    emotional: { _default: ['……もう……言葉にならない……行くよ……！'] },
  },
  defender: {
    normal: {
      _default: ['……私もよ。もう言葉はいらない', '……なら、超えてみせなさい'],
      ojousama: ['……ええ。もう言葉は不要ですわ'],
      delinquent: ['……ああ。来いよ'],
      cool: ['……ああ'],
      seductive: ['……ええ。もう何も言わないわ'],
    },
    bold: {
      _default: ['……ええ。私も同じ気持ち', '……受けて立つ。全部受け止める'],
      cool: ['……受けて立つ'],
    },
    quiet: {
      _default: ['………（静かに頷く。それだけで十分だった）'],
      cool: ['………（目を閉じ、そして開く）'],
    },
    shy: { _default: ['………うん（静かに頷く）'] },
    easygoing: { _default: ['……うん。もう、何も言わなくていい'] },
    earnest: { _default: ['……はい。全力で参ります'] },
    emotional: { _default: ['……ええ……！ 行きましょう……！'] },
  },
};
...
const RIVALRY_MATCH_REACTION = {
  winnerLines: {
    normal: {
      _default: ['まだ終わっていない。次も必ず勝つわ', 'これで終わり……というわけには行かないわね'],
    ...
    bold: {
      _default: ['この勝利は通過点。本当の決着はまだ先にある'],
    ...
    shy: { _default: ['勝てた…よかった…でも、次も頑張らなきゃ…'] },
    easygoing: {
  ...
  loserLines: {
    normal: {
      _default: ['次は負けない。絶対に', '……覚えていなさい。この借りは必ず返す'],
    ...
    bold: {
      _default: ['認めない。この負けは認めない。必ず借りを返すから'],
      cool: ['……忘れない。この敗北を'],
    },
    quiet: {
      _default: ['………（静かに拳を握りしめる）'],
...
const UPSET_RIVALRY_LINES = {
  winnerLines: {
    normal: {
      _default: ['見たでしょ……！ 私が格下だなんて、もう言わせない……！'],
    ...
    bold: {
      _default: ['ついに……ついに勝った……！ この日をどれだけ待ったか……！'],
      cool: ['……やった。……ようやく'],
    },
    quiet: {
    ...
    shy: { _default: ['え…うそ…私が…？ ほんとに…？（膝から崩れる）'] },
    easygoing: {
  ...
  // 番狂わせ敗者セリフ — 格上が格下に負けた衝撃・動揺・屈辱
  loserLines: {
    normal: {
      _default: ['噓でしょ？……こんなはずは……', 'なんで……なんで負けたの……？'],
      ojousama: ['こんな……こんなことがありますの……？'],
      delinquent: ['くそっ……ありえねえ……！'],
      cool: ['………（信じられないという表情で立ち尽くす）'],
      seductive: ['嘘でしょう……こんなことが……'],
    },
    bold: {
      _default: ['認めない……！ こんな結果……認めない……！', 'ありえない……嘘でしょ……！'],
      ojousama: ['認めませんわ……！ こんな結果……！'],
      delinquent: ['ふざけんな……！ こんなの認めねえ……！'],
      cool: ['……嘘だろう'],
    },
    quiet: {
      _default: ['………（呆然と天井を見上げている）'],
      cool: ['………（膝をつき、動かない）'],
    },
    shy: { _default: ['…え……うそ…………（何が起きたかわかっていない）'] },
    easygoing: {
      _default: ['えっ……嘘でしょ……マジで……？'],
      delinquent: ['は……？ マジかよ……'],
    },
    earnest: {
      _default: ['こんなはずでは……油断したつもりはなかったのに……', '信じられません……なぜ……'],
      polite: ['こんな……全力を出したはずなのに……'],
    },
    emotional: { _default: ['嫌だ……！ こんなの嫌だ……！ なんで……！'] },
  },
};
