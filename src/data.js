...
const ALL_COACHES = [
  ...
  {id:1, name:'鬼塚道場長',          emoji:'💪', hasPortrait:true,
  ...
  {id:2, name:'飛鳥トレーナー',      emoji:'💨', hasPortrait:true,
  ...
  {id:3, name:'鶴見師範',            emoji:'🎯', hasPortrait:true,
  ...
  {id:4, name:'岩田フィジカルコーチ', emoji:'🏃', hasPortrait:true,
  ...
  {id:5, name:'沢村メンタルコーチ',  emoji:'🧠', hasPortrait:true,
  ...
  {id:6, name:'朝日総合アドバイザー', emoji:'⭐', hasPortrait:true,
  ...
  {id:7, name:'紅林セコンド',        emoji:'🎬', hasPortrait:true,
  ...
  {id:8, name:'白川マネージャー',    emoji:'📣', hasPortrait:true,
