...
const AUTUMN_WAR_MVP_LINES = {
  gauntlet: {
    normal: {
      ...
      ojousama: [
        'お身体はもう悲鳴を上げていますわ。ですが……このリングを明け渡す理由にはなりませんの',
      ...
      delinquent: [
        '何人来ようが関係ねえ。全員倒して、最後に立ってんのがあたしだ',
    ...
    easygoing: {
      ...
      delinquent: [
        ...
        '何人だっけ？ まあいいや、全員倒したし。あたしの勝ちってことで',
      ],
      cool: [
    ...
    emotional: {
      ...
      composed: [
        '限界は何度も訪れた。それでも……足が前に出た。理屈ではなく、意地だった',
        '身体は壊れかけている。だが……最後に立っていた。それだけで、十分だ',
      ],
      ojousama: [
  ...
  champion: {
    normal: {
      ...
      ojousama: [
        '三人で掴んだ勝利ですわ。わたくし一人では、こうはなりませんの',
      ...
      delinquent: [
        '三人でもぎ取った勝ちだ。あたし一人の手柄じゃねえよ',
        '仲間が繋いでくれたから、あたしはここにいる。それだけだろ',
      ],
      cool: [
        '三人の勝利。それ以上でも以下でもない',
    ...
    shy: {
      ...
      polite: [
        'わ、私がMVPなんて……二人がいてくれたから、ここまで来られたんです',
        '三人で勝てて、本当によかったです。私は……二人に助けられてばかりで',
      ],
      seductive: [
    ...
    emotional: {
      ...
      composed: [
        '三人の勝利だ。一人では……ここには、到底たどり着けなかった',
        '仲間が繋いでくれた道を……最後まで歩けた。それが、何より……',
      ],
      ojousama: [
  ...
  defiant: {
    normal: {
      ...
      ojousama: [
        'お褒めいただけるのは光栄ですわ。ですが……団体が負けたという事実は、変わりませんの',
        'この賞だけでは、わたくし、満足できませんわ。次は三人で勝ちますの',
      ],
      polite: [
    ...
    bold: {
      _default: [
        ...
        'MVP？ そんなもんで満足できるかよ。次は団体ごと叩き潰す',
        '個人で勝っても、チームが負けたら意味がない。次は絶対に獲る',
      ],
      composed: [
        '賞は受け取ろう。だが……次は旗ごともらいに行く。覚えておけ',
        'この程度で満足する性分ではない。次は、全てを攫う',
      ],
      ojousama: [
        'お賞はいただきますわ。ですが……次は優勝旗もわたくしの手元に参りますのよ',
    ...
    emotional: {
      ...
      composed: [
        '賞は受け取ろう……だが、この胸の内は……次に晴らす他ない',
        '足りなかった……それだけが、今は重い。次こそ……全てを',
      ],
      ojousama: [
...
const CHALLENGE_LINES = {
  ...
  // ═══ polite 系 ═══
  polite_earnest: {
    petition: ['社長、ご迷惑は承知しています。それでも、あの方とやらせていただけませんか。','不躾なお願いだと分かっています。……あの方と、闘わせてください。','社長。どうかお願いします。あの方とだけは、やらせていただきたくて。'],
  ...
  polite_normal: {
    petition: ['社長、お願いがあります。あの方と、やらせていただけませんか。','どうしても、あの方とやってみたいんです。……お願いします。','叶うなら、あの方と。……我慢できなくて、言いに来ました。'],
  ...
  polite_shy: {
    petition: ['あの……社長。あの方と、やらせていただけませんか。','言いにくいのですが……どうしても、あの方と。','すみません、わがままです。それでも、お願いしたくて。'],
  ...
  polite_easygoing: {
    petition: ['社長、あの方とやってみたいのですけれど、だめでしょうか。','あの方と一度、やってみたいんです。だめならいいので。','ふと思ったんです。あの方とやってみたいなって。'],
  ...
  polite_quiet: {
    petition: ['社長。……あの方と、お願いします。','一つだけ。あの方と、やらせてください。','……お願いがあります。あの方と。'],
  ...
  polite_bold: {
    petition: ['社長、あの方とやります。許可をください。','決めてきました。あの方と、やらせてください。','必ず勝ちます。あの方との試合、通してください。'],
  ...
  // ═══ composed 系 ═══
  composed_normal: {
    petition: ['社長。……頼みがあります。あの人と、やらせてください。','あの人と、一度やってみたい。……それだけなんです。','無茶を言ってる自覚はあります。……それでも、お願いします。'],
  ...
  composed_emotional: {
    petition: ['社長。…あの人のことが、まだ腹の底に残ってます。やらせてください。','…ずっと呑み込んできました。もう限界です。あいつと、やらせてください。','社長。…静かに言いますけど、本気です。あの人と、やらせてください。'],
  ...
  composed_earnest: {
    petition: ['社長。…あの人と、やらせてください。覚悟はできています。','…わがままを言います。あの人と、やらせてください。責任は取ります。','社長。…自分に必要な相手です。あの人と、お願いします。'],
    ...
    lose: ['負けました。…わがままを通した挙句、この結果です。申し訳ありません。','完敗です。…社長の判断を、無駄にしました。','…すみません。頼み込んだのは自分なのに、勝てませんでした。'],
  },
  composed_bold: {
    petition: ['社長。……あの人は、私が引き受けるよ。','頼みがあるの。あの相手と、やらせてほしい。','……名前を挙げさせてもらうね。あの人と、やりたい。'],
  ...
  composed_easygoing: {
    petition: ['社長、ちょっといい? ……やってみたい相手がいるの。','……あのね。あの人と、やらせてもらえないかな。','お願いがあるんだけど。……あの相手、私に回してくれない?'],
  ...
  composed_quiet: {
    petition: ['社長。…あの人と、やりたいです。','…お願いが、ひとつだけ。あの人と、やらせてください。','社長。…あの人です。お願いします。'],
  ...
  // ═══ seductive 系 ═══
  seductive_normal: {
    petition: ['社長、正直に言うわ。対戦したい相手が居るのよね。','{org}のあいつが気に障るのよね・・・対戦、セッティングしてくれる?','理由は言いたくないのだけれど。試合を組んで欲しいの。'],
  ...
  seductive_easygoing: {
    petition: ['社長〜、あの人とやりたいの。だめ?','ねえ社長、あの人と当てて。お願い。','あの人とやらせて? わがままよね、私。'],
  ...
  seductive_earnest: {
    petition: ['社長、あの人とやらせてほしいの。お願いします。','どうしてもあの人とやりたくて。……聞いてくれる?','身勝手なお願いなの。あの人と、やらせて。'],
  ...
  seductive_bold: {
    petition: ['社長、{org}のあの女、私にやらせて。','気に入らない女がいるの。……そいつと、やらせてほしいのよ。','身の程を教えてあげたい相手がいるの。組んでくれる?'],
  ...
  seductive_quiet: {
    petition: ['社長。あの人と、やらせてほしいの。','お願いがあるの。……あの人と、やりたい。','一度、あの人と。……いいかしら。'],
  ...
  seductive_emotional: {
    petition: ['社長。あの人とやりたいの。……いいでしょ?','我慢が切れたの。あの人と、やらせて。','言うだけ言うわ。あの人と当てて。'],
  ...
  // ═══ ojousama 系 ═══
  ojousama_normal: {
    petition: ['社長、わたくし、あの方と対戦したいのです。','お願いがあります。あの方と試合をさせてくださいませ','不躾を承知で申します。あの方と当たりたいのです。'],
  ...
  ojousama_easygoing: {
    petition: ['社長、わたくし、あの方とやってみたいのです。','ねえ社長、あの方と当ててくださいません?','思いつきではないのです。あの方と、試合を。'],
  ...
  ojousama_earnest: {
    petition: ['社長、お願いがあります。あの方と戦わせてください。','わたくし、あの方と対戦したいのです。どうか。','願いはひとつです。あの方と、当たらせてください。'],
  ...
  ojousama_bold: {
    petition: ['社長、あの方はわたくしが引き受けますわね。','あの方と対戦したいのです。適任はわたくしでしょう。','名指しさせていただくわ。あの相手との舞台、整えられる?'],
  ...
  // ═══ delinquent 系 ═══
  delinquent_bold: {
    petition: ['社長、あいつとやらせてくださいよ。勝てるんで。','あいつとやりたいんす。……頼みます、組んでください。','言わなきゃ回ってこねぇんで、直接来ました。お願いします。'],
    sendoff: ['あざっす! ……行ってきます。','ありがとうございます。……勝ってくるんで、心配いらないっす。','話通してくれて、あざっした。ちゃんとやってきます。'],
    win: ['勝ったっす! ……ほら、言った通りでしょ。','勝ちました。社長、ありがとうございました。','やってきました。……頼んだ甲斐、あったでしょ?'],
    lose: ['……負けたっす。すんません。','悔しいっすね。……次は、こうはいかねぇんで。','負けました。……でも、やらせてもらってよかったっす。'],
  },
  delinquent_normal: {
    petition: ['社長、あの人とやらせてください。','お願いがあるんすよ。あの人と当ててほしい。','ずっと引っかかってる相手がいる。組ませてください。'],
  ...
  delinquent_easygoing: {
    petition: ['社長、あの人とやらせてよ。頼む。','やりたい相手がいるんだ。組んでくれ。','なあ社長、あの人と当ててくれない?'],
  ...
  // ═══ cool 系 ═══
  cool_normal: {
    petition: ['……社長。あの人と、やらせてください。','……頼みがあります。あの人と、やりたい。','……あの人だ。あの人と、やらせてほしい。'],
  ...
  cool_quiet: {
    petition: ['……社長。あの人と。','……願いが、ひとつ。あの人と。','……やりたい相手が、います。'],
...
const CHALLENGE_REQUEST_OPPONENT_REACTIONS = {
  ...
  // ═══ polite 系 ═══
  polite_earnest: {
    _accept: ['ご指名、確かに受け取りました。全力でお相手します。','わたしを選んだのなら、その責任は果たします。','お受けします。半端な気持ちでは、向き合いません。'],
    win: ['受けた以上、負けるわけにはいきませんでした。','あなたの本気、確かに受け止めました。','勝ちました。あなたの覚悟には、応えられたはずです。'],
    lose: ['……受けておいて、この結果です。悔やみます。','あなたが上でした。言い訳はいたしません。','わたしの力不足です。……この負けは、忘れません。'],
  ...
  polite_normal: {
    ...
    win: ['お受けして良かったです。いい試合でした。','今日はわたしが上でしたね。お強かったですよ。','勝たせていただきました。またいつでも、どうぞ。'],
    lose: ['わたしの力が及びませんでした。お見事です。','悔しいです。……ですが、受けたことに悔いはありません。','完敗です。次は、違う結果をお見せします。'],
    draw: ['決着つかず、ですか。……心残りです。','引き分けですね。続きは、またの機会に。','引き分けというのは、いちばん困りますね。'],
  },
  polite_shy: {
    ...
    draw: ['引き分け……。よかったのか、悪かったのか。','決着、つかなかったですね……。少し、ほっとしてます。','あの……もう一度、やりますか。今度は、ちゃんと。'],
  },
  polite_easygoing: {
    _accept: ['あら、わたしですか。いいですよ、やりましょう。','お受けします。せっかく呼ばれましたし。','そんなに構えなくていいですよ。ちゃんとお相手します。'],
    ...
    draw: ['引き分けですって。ちょうどいいじゃないですか。','決まりませんでしたね。まあ、またそのうちに。','お互い元気ですねえ。……少し、疲れました。'],
  },
  polite_quiet: {
    ...
    draw: ['……決着は、つきませんでした。','引き分けです。……いつか、続きを。','……終わりません。まだ。'],
  },
  polite_bold: {
    _accept: ['望むところです。逃げも隠れもいたしません。','わたしを選んだこと、後悔することになりますよ。','結構です。そのお気持ち、全部受け止めます。'],
    win: ['申し上げた通りです。お相手が悪かったですね。','わたしを選んだのが、間違いでしたね。','受け止めました。……もう一度、いかがですか。'],
    lose: ['……大きなことを申し上げた分、恥ずかしい限りです。','あなたが上でした。潔く、認めます。','持っていかれましたね。……次はございません。'],
    draw: ['決めきれませんでした。……不本意です。','引き分けは、望んでおりませんでした。','まだ足りませんね。またご指名ください。'],
  },
  ...
  normal_normal: {
    ...
    draw: ['決着つかず、か。すっきりしませんね。','引き分けですね。続きは、またいつか。','勝ててないし、負けてもいない。それだけです。'],
  },
  normal_earnest: {
  ...
  normal_bold: {
    ...
    draw: ['決めきれなかった。……つまらない終わり方だ。','引き分け? そんなの求めてません。','まだ足りない。もう一度、名前を呼んでください。'],
  },
  normal_easygoing: {
  ...
  normal_shy: {
    ...
    draw: ['引き分け……。よかったのか、どうなのか。','決着、つかなかったね……。ちょっと、ほっとしてる。','あの……もう一度、やる? 今度は、ちゃんと。'],
  },
  normal_emotional: {
  ...
  composed_normal: {
    ...
    draw: ['……決まらなかったか。まあ、悪くない。','引き分け。……続きは、そのうちにね。','……お互い、まだ何か残してるってことだ。'],
  },
  composed_emotional: {
    _accept: ['……ふぅん。よく、わたしの名前を出せたね。','……いいよ。言葉はいらない。来なよ。','……そう。じゃあ、覚悟はできてるんだ。'],
    win: ['……これで分かった? 次はないよ。','……言いたいことは、全部言えたよ。','……もう、名前は呼ばないほうがいい。'],
    lose: ['……ちっ。次は、こうはいかない。','……っ……そうかよ。覚えておく。','……何も言わない。今は、何も。'],
  ...
  composed_earnest: {
    ...
    lose: ['……受けておいて、この結果か。情けない。','あんたが上だった。……言い訳はしない。','……負けは、わたしのものだ。持って帰るよ。'],
    draw: ['……決着をつけられなかった。それが心残りだ。','引き分けでは、答えたことにならない。','……まだ途中だ。必ず、続きをやろう。'],
  },
  composed_bold: {
    _accept: ['来なよ。……受けて立つから。','……いい度胸してるね。乗ってあげる。','わたしを選んだんだ。……せいぜい、悔やまないように。'],
    win: ['……ほら、言った通りだろ。','わたしを選んだのが、間違いだったね。','……悪くなかったよ。もう一度来るなら、受ける。'],
    lose: ['……持っていかれたか。大きく出た分、堪えるね。','あんたが上だった。……認めるよ、今日は。','……いい仕事するね。次は、こうはいかない。'],
    draw: ['……決めきれなかったか。つまらないね。','引き分けは、わたしの趣味じゃない。','……まだ足りない。また名前を呼びなよ。'],
  },
  composed_easygoing: {
    _accept: ['…あたし? ま、いいよ。付き合う。','へえ、名指しか。…断る理由もないかな。','そんなに気合い入れなくていいよ。…受けるから。'],
    win: ['…ま、こんなもんかな。悪くなかったよ。','あんた、力入りすぎ。…だから届かない。','勝っちゃったね。…気にしなくていいよ。'],
    lose: ['あー…やられた。まいったな。','うん、あんたの勝ち。…強かったよ。','…完敗。言い訳はしないよ。'],
    draw: ['…引き分けか。まあ、そういう日もある。','決まらなかったね。…また今度でいいよ。','お互い、まだ余ってるね。…楽しみだ。'],
  },
  composed_quiet: {
  ...
  seductive_easygoing: {
    ...
    draw: ['引き分けかぁ。…ま、いいんじゃない?','決まらなかったわね。お茶でも飲む?','もう、しつこいんだから。ふふ。'],
  },
  seductive_earnest: {
  ...
  seductive_bold: {
    ...
    draw: ['決めさせてくれないの? 生意気ね。','まだ足りないわ。…ぜんぜん、足りない。','引き分け? 私は納得してないわよ。'],
  },
  seductive_quiet: {
  ...
  ojousama_normal: {
    ...
    draw: ['決着つかず、ですか。心残りです。','またお相手願います。今度こそ決めたい。','引き分け……納得はしておりません。'],
  },
  ojousama_easygoing: {
    ...
    draw: ['引き分けですか。それも悪くありません。','決まりませんでしたね。またの機会に。','お互い、まだ元気そうです。ふふ。'],
  },
  ojousama_earnest: {
    _accept: ['お受けします。全力でお相手します。','名指しの意味、違えずに応えます。','あなたの覚悟に、礼を欠くことはしません。'],
    win: ['勝ちました。手は一切抜いていません。','あなたは強かった。それは伝えておきます。','勝ちよりも、良い試合だったことが嬉しい。'],
  ...
  ojousama_bold: {
    ...
    draw: ['決めさせないとは、生意気なこと。','引き分けなど、わたくしには不本意です。','まだ終わっていません。次で片をつけます。'],
  },

  // ═══ delinquent 系 ═══
  delinquent_bold: {
    _accept: ['上等じゃん。名指しとかいい度胸してんな。','来いよ。全部まとめて叩き返してやる。','あたしを選んだ時点で、勝負ありだろ。'],
    win: ['ほらな。届かねぇって言ったろ。','イキがるのはここまでだ。分かったか。','もう一回来い。何度でも潰してやる。'],
    lose: ['ちっ……やるじゃねぇか、あんた。','痛ぇな。…けど次はこうはいかねぇ。','負けだよ。悔しくて仕方ねぇけどな。'],
    draw: ['決まらねぇとか、一番むかつくんだよ。','はぁ? まだ全然終わってねぇだろ。','引き分け? 冗談。続きやるぞ。'],
  },
  delinquent_normal: {
    ...
    draw: ['引き分けか。すっきりしねぇな。','決着つかずって、一番モヤるやつだ。','まあ、悪い試合じゃなかったっす。'],
  },
  delinquent_easygoing: {
    _accept: ['お、あたし? いいよ、やろうやろう。','めんどくせ……ま、断る理由もねぇか。','そんな睨むなって。受けるっての。'],
    win: ['勝っちった。まあ、そういう日もあるって。','あんた力入りすぎ。もっと抜けよ。','悪ぃ悪ぃ。今日はこっちの気分だった。'],
    lose: ['あー、やられた。強ぇなあんた。','まいったまいった。降参だよ。','負けたわ。…ま、しゃーない。'],
    draw: ['引き分けか。ちょうどいいんじゃね?','決まんなかったな。腹減った。','まだやんの? あたしはもういいよ。'],
  },
...
function getAutumnWarMatchLine(context, personality, archetype, rng) {
  ...
  const pData = contextData[personality] || contextData.normal;
  if (!pData) return '';
  const lines = pData[archetype] || pData._default || [];
  if (lines.length === 0) return '';
  if (rng) return lines[Engine.rng.int(rng, 0, lines.length - 1)];
...
const NEWS_HEADLINE_TEMPLATES = {
  ...
  titleChange: [
    ...
    { headline: '王座交代！{name}が{org}の頂点を奪取',
      body: '壮絶な一戦の末、{name}が新チャンピオンに。敗れた{prevChamp}は雪辱を期すことになる。{org}の新時代が始まる。' },
    { headline: '{org}に新女王誕生。{name}が王座を戴冠',
      body: '{prevChamp}の牙城を崩した{name}。ファンの歓声が会場を包む中、新王者の時代が幕を開けた。' },
  ],
  defenseRecord: [
  ...
  breakthrough: [
    ...
    { headline: '{name}にブレークスルー。{org}の新たな武器に',
      body: '地道な努力がついに実を結んだ。{org}の{name}が{detail}。本人も驚くほどの変化だという。チームの戦力が一段上がった。' },
  ...
  motivationLoss: [
    ...
    { headline: '{name}の去就に暗雲。{org}は引き留められるか',
      body: '{org}の{name}が闘志を失いつつあるという。関係者によると、プロレスを楽しめなくなっていると漏らしているとか。復活を願う声が業界に広がる。' },
    { headline: '{org}の{name}、心ここにあらず。業界に衝撃',
      body: 'かつてリングを沸かせた{name}の目から光が消えた。何のために戦うのか——それを見失った姿に、ファンは言葉を失った。' },
  ],
  hallOfFame: [
    { headline: '栄光の殿堂入り！{name}の輝かしいキャリアを振り返る',
      body: 'タイトル{titles}回獲得、防衛{defenses}回。{name}の偉大なキャリアに、業界全体が敬意を表した。プロレスに全てを捧げた半生が、この日たしかに報われた。' },
    { headline: '{name}、殿堂入り。伝説は永遠に刻まれた',
      body: '数々の名勝負を生んだ{name}が殿堂入り。受賞の挨拶が終わると、会場はスタンディングオベーションに包まれた。' },
    { headline: '感動の殿堂入りセレモニー。{name}に万雷の拍手',
      body: '引退後もなおファンに愛される{name}。タイトル{titles}回、防衛{defenses}回の偉業。後輩たちに繋いだ道は、これからも色褪せない。' },
  ],
  retirement: [
    { headline: 'ありがとう{name}――リングに別れを告げた戦士',
      body: '{org}の{name}が現役を退いた。{detail}。最後まで全力で闘い抜いてリングを降りる姿に、ファンから惜別の涙が溢れた。' },
    { headline: '{name}、引退。{org}の一時代が終わる',
      body: '{org}を支えた{name}がリングを去った。{detail}。最後に深々と下げられた頭が、全てを物語っていた。' },
    { headline: 'さようなら{name}。最後のゴングが鳴った',
      body: '長きにわたり{org}を背負った{name}が引退を決断。{detail}。悔いはないと言い切る、その穏やかな表情が印象的だった。' },
  ],
  ...
  poachSuccess: [
    { headline: '電撃移籍！{name}が{toOrg}に加入。{fromOrg}は大打撃か',
      body: '{fromOrg}の{name}が{toOrg}への移籍を決断。OVR{ovr}の実力者の流出に{fromOrg}関係者は衝撃を隠せない。新天地で自分を試す道を選んだ形だ。' },
  ...
  lockerRoomCrisis: [
    { headline: '{org}ロッカールームに不穏——険悪ペア{count}組、内部に亀裂',
      body: '{org}の控室に重い空気が立ち込めている。絆の崩れた{count}組が同じ空間で身を支度する日々——挨拶もなく、目線も合わない。「あの空気の中で試合に出ろと言われても」と若手が漏らす。社長が動かなければ、これは長引く。' },
  ...
  hatredContagion: [
    ...
    { headline: '心の伝染——{carrier}の中で{enemy}への感情が変わった',
      body: '{org}の{carrier}は、{friend}が{enemy}を見る目を覚えてしまった。それは知らず知らずに自分の判断にも染み込んでいく。気づけば、あの人と前のように話すことはなくなっていた。' },
  ],
  relationshipRepair: [
...
const CHOICE_EVENT_DIALOGUES = {
  S1: {
    ...
    quiet: {
      ojousama: ['……あの。わたくしに、挑戦の機会を'],
      delinquent: ['……ベルト、挑ませてくれ。頼む'],
      composed: ['……挑戦、させてほしい。それだけ'],
      _default: [
        '……挑戦させてください'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['あの…わたくし…その、ベルトに…挑戦させていただけませんか…'],
      delinquent: ['あの…その…タイトル、挑ませてもらえないっすか…'],
      cool: ['…あの。…タイトル、挑戦したい'],
      seductive: ['あの…笑わないで聞いてほしいの…ベルト、挑ませてもらえない…？'],
      composed: ['…言い出しにくいんだけど。…ベルトに、挑戦させてもらえないかな'],
      _default: [
    ...
    easygoing: {
      cool: ['…ベルトが欲しい。組んでくれ', '…タイトル戦。やらせてほしい'],
      composed: ['…ねえ、タイトル戦って組めないかな', '…ベルト、ちょっと欲しくなってさ。挑ませてよ'],
      _default: [
        'ねえねえ、タイトルマッチ組んでよ！',
        'ベルト欲しいなー。挑戦させてくれない？'
      ],
    ...
    earnest: {
      delinquent: ['ずっと準備してきたんだ。チャンスをくれよ', 'タイトル戦、挑ませてくれ。本気で頼む'],
      cool: ['…準備はできてる。機会をくれ', '…タイトル戦に、挑ませてほしい'],
      _default: [
    ...
    emotional: {
      ojousama: ['お願いします…！わたくしに、ベルトへ挑む機会を…！'],
      delinquent: ['頼む…！タイトル戦、挑ませてくれ…！'],
      cool: ['…頼む。ベルトに、挑ませてくれ'],
      polite: ['お願いします…！どうか、タイトル戦に挑ませてください…！'],
      composed: ['…頼むよ。ベルト、挑ませてほしい。…もう、待てないんだ'],
      _default: [
  ...
  S2: {
    ...
    quiet: {
      ojousama: ['……あの方と。戦わせていただけませんか'],
      delinquent: ['……あいつと。…やらせてくれ'],
      composed: ['……あの人と、やらせてほしい。それだけ'],
      _default: [
        '……あの人と、戦わせてください'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['あの…わたくし、あの方と…試合を組んでいただけませんか…'],
      delinquent: ['あの…あいつと、試合…組んでもらえないっすか…'],
      cool: ['…あの。…あの人と、やりたい'],
      seductive: ['あの…あの人と、試合…組んでもらえない…？ 変よね、こんなの…'],
      composed: ['…言いにくいんだけど。…あの人と、やらせてもらえないかな'],
      _default: [
    ...
    easygoing: {
      cool: ['…あの人と。決着をつけたい'],
      composed: ['…ねえ、あの人との試合、組んでくれない？ 決着つけたくてさ'],
      _default: [
    ...
    earnest: {
      delinquent: ['あいつを越えねぇと先がねぇんだ。試合、組んでくれ'],
      cool: ['…あの人を越えたい。組んでくれ'],
      _default: [
    ...
    emotional: {
      ojousama: ['あの方と戦いたいんです…！どうか、組んでください…！'],
      delinquent: ['あいつとやりてえんだ…！頼む、組んでくれ…！'],
      cool: ['…あの人と、やりたい。頼む'],
      polite: ['あの人と戦いたいんです…！お願いします、組んでください…！'],
      composed: ['…あの人と、やらせてほしい。…これだけは、譲れないんだ'],
      _default: [
  ...
  S3: {
    ...
    quiet: {
      ojousama: ['……少しだけ。お休みを、いただけませんか'],
      delinquent: ['……悪い。少し、休ませてくれ'],
      composed: ['……休みたい。少しでいいんだ'],
      _default: [
        '……少し、休ませてください'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['あの…申し訳ありません…体が…少し、休ませていただけませんか…'],
      delinquent: ['あの…すんません…体がもう…少し休ませてもらえねぇっすか…'],
      cool: ['…あの。…体が、もたない。休みたい'],
      seductive: ['あの…ごめんなさい…体が、もう…少しだけ休ませて…？'],
      composed: ['…情けない話なんだけど。…体が持たない。少し休ませてほしい'],
      _default: [
    ...
    earnest: {
      delinquent: ['迷惑かけて悪いんだけど…少し休ませてもらえねぇか', 'みんなに迷惑かけたかねぇ…けど、体がもう限界なんだ'],
      cool: ['…迷惑をかける。それでも、休ませてくれ', '…みんなに悪いが、体が限界だ'],
      _default: [
    ...
    emotional: {
      ojousama: ['申し訳ありません…！みっともないところを…体が、もう…休ませてください…！'],
      delinquent: ['悪ぃ…！体がもう限界なんだ…休ませてくれ…！'],
      cool: ['…すまない。体が、もう…休ませてくれ'],
      polite: ['ごめんなさい…！もう、体が…どうか、休ませてください…！'],
      composed: ['…すまない。体が、もう限界でさ。…少し休ませてほしい'],
      _default: [
  ...
  S4_direct: {
    ...
    quiet: {
      ojousama: ['……申し上げます。…このままでは、わたくし、続けられません'],
      delinquent: ['……言わせてもらう。…このままじゃ、もたねえ'],
      composed: ['……黙ってたけどね。…このままは、無理だよ'],
      _default: [
        '………（険しい目でこちらを見つめている）'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['あの…申し訳ありません…でも…このままでは、わたくし…'],
      delinquent: ['…あの…悪ぃんすけど…このままじゃ、もう…'],
      cool: ['…あの。…このままは、無理だ'],
      seductive: ['あの…ごめんなさい…でも、このままじゃ…わたし…'],
      composed: ['…こんなこと言いたくないんだけどね。…このままだと、もたないよ'],
      _default: [
        '…あの…ごめんなさい…でも…このままだと…'
      ],
      polite: [
    ...
    easygoing: {
      cool: ['…不満がある。話をさせてくれ'],
      composed: ['…正直、不満があってさ。…一度、ちゃんと話そうよ'],
      _default: [
    ...
    earnest: {
      delinquent: ['ずっと我慢してきたんだ。でも、このままじゃ…', '目標に届く場所じゃねぇと意味がねぇ。考え直してくれよ'],
      cool: ['…ずっと黙ってた。だが、もう限界だ', '…目標に届く環境がいる。考え直してくれ'],
      _default: [
    ...
    emotional: {
      ojousama: ['…もう…耐えられません…！このままでは、わたくし…！'],
      delinquent: ['…もう…無理だっつってんだよ…！このままじゃ、あたし…！'],
      cool: ['…もう、無理だ。…このままなら、続けられない'],
      polite: ['…申し訳ありません…！でも、もう…このままでは、わたし…！'],
      composed: ['…もう無理だよ。…このままなら、ここにはいられない'],
      _default: [
        '…もう…無理です…！このままだと…私…！'
      ],
      seductive: [
  ...
  S4_silent: {
    normal: {
      ojousama: ['（…申し上げたいことは、ございます。けれど、口にはできません）'],
      delinquent: ['…（沈黙）…いや、なんでもねえよ'],
      cool: ['………（首を振って、口をつぐんだ）'],
      seductive: ['…（沈黙）…ううん、なんでもないの'],
      composed: ['…（少し間を置いて）…いや、なんでもないよ'],
      _default: [
        '（沈黙）…いえ、何でもないです'
      ]
    },
    bold: {
      ojousama: ['…………（膝の上で、手を固く握りしめている）'],
      delinquent: ['…………（舌打ちをこらえて、拳を握っている）'],
      cool: ['…………（拳を握ったまま、視線を外さない）'],
      seductive: ['…………（笑みは崩さないまま、指先だけが強く握られている）'],
      composed: ['…………（拳を握り、それから静かに息を吐いた）'],
      _default: [
        '…………（拳を握りしめている）'
      ]
    },
    quiet: {
      ojousama: ['…………（小さく息をつき、そっと目を伏せる）'],
      delinquent: ['…………（舌打ちをひとつ、そっぽを向く）'],
      composed: ['…………（ひとつ息をついて、それきり黙っている）'],
      _default: [
        '…………（小さくため息をつき、視線を逸らす）'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['…………（目を伏せたまま、言葉を探しあぐねている）'],
      delinquent: ['…………（下を向いたまま、何も言えずにいる）'],
      cool: ['………（目を合わせず、口を閉ざしている）'],
      seductive: ['…………（何か言いかけて、力なく微笑んだだけだった）'],
      composed: ['…………（目を伏せて、それきり口を開かない）'],
      _default: [
        '…………（目を逸らして、何も言えずにいる）'
      ],
      polite: [
    ...
    easygoing: {
      delinquent: ['あー…いや、なんでもねえって（笑ってはいるが、目が笑っていない）'],
      cool: ['…別に。…なんでもない（薄く笑って、目を逸らした）'],
      seductive: ['ふふ…ううん、なんでもないの（笑顔のまま、目だけが冷えている）'],
      composed: ['…いや、なんでもないよ（笑ってみせたが、目は笑っていない）'],
      _default: [
        'あはは…いや、なんでも…（笑っているが目が笑っていない）'
      ]
    },
    earnest: {
      ojousama: ['…………（何か申し上げようと口を開き、そっと閉じた）'],
      delinquent: ['…………（言いかけて、結局は口をつぐんだ）'],
      cool: ['………（口を開きかけ、やめた）'],
      seductive: ['…………（言いかけた言葉を、笑みの奥に飲み込んだ）'],
      polite: ['…………（何か申し上げかけて、深く頭を下げるだけだった）'],
      composed: ['…………（言いかけて、ひとつ息をつき、そのまま黙った）'],
      _default: [
        '…………（何か言いたげに口を開きかけ、止める）'
      ]
    },
    emotional: {
      ojousama: ['……っ（唇を噛み、こみ上げるものを必死にこらえている）'],
      delinquent: ['……っ（歯を食いしばって、目元を腕でぬぐった）'],
      cool: ['……っ（唇を噛んで、顔を背けた）'],
      polite: ['……っ（涙をこらえるように、深く頭を下げたまま動かない）'],
      composed: ['……っ（込み上げたものを飲み下し、静かに目を閉じた）'],
      _default: [
        '……っ（泣くのを堪えるように唇を噛んでいる）'
      ],
      seductive: [
  ...
  S5: {
    ...
    quiet: {
      ojousama: ['……特訓のお許しを、いただけますか'],
      delinquent: ['……特訓、させてくれ'],
      composed: ['……特訓、させてほしい。それだけ'],
      _default: [
        '……特訓、させてください'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['あの…わたくし、特訓を…もっと強くなりたいんです…お許しいただけませんか…'],
      delinquent: ['あの…特訓、させてもらえないっすか…もっと強くなりてぇんす…'],
      cool: ['…あの。…特訓させてほしい。強くなりたい'],
      seductive: ['あの…特訓、させてもらえない…？ もっと強くなりたいの…'],
      composed: ['…図々しいかもしれないけど。…特訓させてほしい。もっと強くなりたくて'],
      _default: [
    ...
    earnest: {
      delinquent: ['もっと強くなりてぇんだ。特訓、許可してくれ'],
      cool: ['…もっと強くなりたい。特訓を許可してくれ'],
      _default: [
    ...
    emotional: {
      ojousama: ['お願いします…！特訓を…！わたくし、もっと強くなりたいんです…！'],
      delinquent: ['頼む…！特訓させてくれ…！もっと強くなりてぇんだよ…！'],
      cool: ['…頼む。特訓させてくれ。…もっと、強くなりたい'],
      polite: ['お願いします…！特訓させてください…！もっと、強くなりたいんです…！'],
      composed: ['…頼むよ。特訓させてほしい。…まだ、こんなもので終われないんだ'],
      _default: [
  ...
  S6: {
    ...
    quiet: {
      ojousama: ['……後輩の子たちに、伝えたいことがあります'],
      delinquent: ['……後輩に、伝えてぇことがあるんだ'],
      composed: ['……後輩に、渡したいものがあるんだ'],
      _default: [
        '……後輩に、伝えたいことがあるんです'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['あの…わたくしでよろしければ…後輩の子たちに、何かお伝えできたら…'],
      delinquent: ['あの…あたしでよけりゃ…後輩に、何か教えてやりたくて…'],
      cool: ['…あの。…後輩に、伝えたいことがある'],
      seductive: ['あの…わたしでよければ…後輩の子たちに、何か残せたら…って…'],
      composed: ['…おこがましいかもしれないけど。…後輩に、何か残せたらと思ってさ'],
      _default: [
    ...
    easygoing: {
      cool: ['…後輩の面倒、見させてくれ'],
      composed: ['…後輩の面倒、見させてよ。…案外、向いてる気がしてさ'],
      _default: [
        '後輩の面倒見させてよ！楽しそうだし！'
      ],
      delinquent: [
    ...
    earnest: {
      delinquent: ['あたしが積んできたもん、後輩に渡してやりてぇんだ', '後輩に伝えてぇことがある。指導、任せてくれよ'],
      cool: ['…培ったものを、後輩に渡したい', '…後輩の指導を。機会をくれ'],
      _default: [
    ...
    emotional: {
      ojousama: ['後輩の子たちに…わたくしにできることがあるのなら…やらせてください…！'],
      delinquent: ['後輩に…あたしにできることがあるなら…やらせてくれ…！'],
      cool: ['…後輩のために、できることがあるなら。…やらせてくれ'],
      polite: ['後輩の子たちに…わたしにできることがあるのでしたら…やらせてください…！'],
      composed: ['…後輩に残せるものがあるなら、やらせてほしい。…それだけだよ'],
      _default: [
  ...
  E1: {
    normal: {
      cool: ['…メディアの話が来ている。出たい', '…出演の話。やらせてくれ'],
      polite: ['メディア出演のお話をいただきまして…ご検討いただけますでしょうか', '出演のお話をいただきました。ぜひ、やらせていただきたいです'],
      _default: [
        'メディアへの出演、ご検討いただけますか？',
    ...
    bold: {
      polite: ['この露出を足がかりに、もっと大きな舞台へ行きたいんです', 'わたしが出れば注目は集まります。任せてください'],
      _default: [
    ...
    quiet: {
      ojousama: ['…メディアの、お話。…恥ずかしくないよう努めます'],
      delinquent: ['…出演の話か。…やる'],
      seductive: ['…出演の話…？ …やってみるわ'],
      composed: ['…出演の話か。…受けるよ'],
      _default: [
        '…出演のお話、ですか…頑張ります'
      ],
    ...
    shy: {
      ojousama: ['え…テレビ、ですか…？ わたくしなんかが…で、でも、やってみたいです…'],
      delinquent: ['え…テレビ…？ あたしなんかが…で、でも…やってみてぇっす…'],
      cool: ['…テレビ。…私なんかが。…でも、やる'],
      seductive: ['え…テレビ…？ わたしなんかで…でも、やってみたいの…'],
      composed: ['…テレビか。…私でいいのかな。…でも、やってみたいよ'],
      _default: [
    ...
    easygoing: {
      ojousama: ['ファンの皆さまに、もっと近くで見ていただきたいんです', 'テレビ…！わたくし、出てみたいです'],
      cool: ['…もっと近くで、見てもらいたい', '…テレビ。出る'],
      polite: ['もっと多くの方に見ていただきたくて…出させていただけませんか', 'テレビ、ですか…！ぜひ、出させてください！'],
      composed: ['…もっと近くで見てもらいたくてさ。出してよ', '…テレビか。いいね、出るよ'],
      _default: [
    ...
    earnest: {
      delinquent: ['テレビは緊張すんだけど…精一杯やらせてくれ'],
      cool: ['…緊張はする。でも、やる'],
      _default: [
        'テレビは緊張しますけど…精一杯やります！'
      ],
    ...
    emotional: {
      ojousama: ['テレビ…！？ わたくしが…嬉しい…！精一杯やります…！'],
      delinquent: ['テレビ…！？ マジか…！うれしい…！やってやる…！'],
      cool: ['…テレビ。…っ、…やる。ありがとう'],
      polite: ['テレビ、ですか…！？ 嬉しいです…！精一杯やります…！'],
      composed: ['…テレビか。…っ、…嬉しいね。やらせてもらうよ'],
      _default: [
        'テレビ…！？ えっ…嬉しい…！頑張ります…！'
      ],
      seductive: [
  ...
  E4: {
    normal: {
      ojousama: ['新しいスカウトのお話が、届いているそうです'],
      delinquent: ['新しいスカウトの話、来てるみたいっすよ'],
      cool: ['…スカウトの報告が来ている'],
      seductive: ['新しいスカウトのお話が来てるみたいよ'],
      composed: ['…スカウトから、新しい話が来てるみたいだよ'],
      _default: [
        '新たなスカウト情報が届きました'
      ]
    },
  ...
  shy: {
    ojousama: ['え、ええと…その…お話のことは…'],
    delinquent: ['え、えっと…その…その話は、あたしからはなんとも…'],
    cool: ['…えっと。…その件は'],
    seductive: ['え、ええと…その件は…わたしからは、ちょっと…'],
    composed: ['…えっと。…その件は、私からはなんとも言えないな'],
    polite: [
      'え、ええと…そ、その件は…'
    ]
  },
  ...
  E6: {
    ...
    quiet: {
      ojousama: ['………他所から、お話が（声を落として）'],
      delinquent: ['………他所から、話が来てる（小さな声で）'],
      composed: ['………他所から、話が来てるんだ（声を落として）'],
      _default: [
        '………他から、話が（小さな声で）'
      ],
      cool: [
    ...
    shy: {
      ojousama: ['あの…他の団体からお話が…その…どうすればよいのか、わからなくて…'],
      delinquent: ['あの…他所から話が来てて…その…どうしたらいいか、わかんねぇんす…'],
      cool: ['…あの。…他所から話が来た。…どうすればいい'],
      seductive: ['あの…他所から、お誘いが…その…どうしたらいいか、わからなくて…'],
      composed: ['…その、他所から話が来ててさ。…どう答えたものか、わからないんだ'],
      _default: [
    ...
    easygoing: {
      cool: ['…他所が私を欲しいらしい。…少し、嬉しい'],
      composed: ['…他所が私を欲しいってさ。…ちょっと嬉しいかもね'],
      _default: [
    ...
    earnest: {
      delinquent: ['義理があるから断ったけどよ…一応、報告しとく', 'みんなと離れたかねぇ…けど、正直、迷ってんだ'],
      cool: ['…義理がある。断った。報告まで', '…離れたくはない。だが、迷ってる'],
      _default: [
    ...
    emotional: {
      ojousama: ['他の団体からお話が…どうしましょう…迷っているんです…'],
      delinquent: ['他所からオファーが来て…どうすりゃいいんだよ…迷ってんだ…'],
      cool: ['…他所から話が来た。…迷ってる'],
      polite: ['他の団体からオファーが…どうしたらいいか…迷っています…'],
      composed: ['…他所から話が来てるんだ。…どうしたものかな。正直、迷ってる'],
      _default: [
  ...
  S_boycott: {
    ...
    bold: {
      ojousama: ['練習…？ 出していただけないのに、意味がありますか', 'リングに上がれないのなら、稽古など無駄でしょう'],
      cool: ['…出さないなら、練習する意味がない', '…リングに上がれないなら、やるだけ無駄だ'],
      seductive: ['練習？ 出してもくれないのに、意味があるのかしら', 'リングに上がれないなら、やっても同じでしょう？'],
      composed: ['…出してもらえないのに、練習する意味あるのかな', '…リングに上がれないなら、同じことだよ'],
      _default: [
    ...
    quiet: {
      ojousama: ['…………（何も言わず、静かに道場をあとにしようとしている）', '……申し訳ありません…今日は……'],
      delinquent: ['…………（何も言わず、荷物を担いで出ていこうとしている）', '……悪い…今日は……'],
      polite: ['…………（一礼だけして、道場を出ていこうとしている）', '……申し訳ございません…今日は、どうしても……'],
      composed: ['…………（何も言わずに、道場の戸口へ向かっている）', '……悪いね…今日は……'],
      _default: [
        '…………（黙って道場を出ていこうとしている）',
        '……すみません…今日は……'
      ],
    ...
    easygoing: {
      delinquent: ['はは…今日はサボるわ…', '練習な…うーん、今日はパスで'],
      cool: ['…今日は、やらない', '…練習。…今日はいい'],
      seductive: ['ふふ…今日はサボっちゃおうかな…', '練習ねぇ…今日は、遠慮しておくわ'],
      composed: ['…今日は、休ませてもらおうかな', '…練習ね。…今日はいいや'],
      _default: [
        'あはは…今日はちょっとサボりまーす…',
        '練習ねぇ…うーん、今日はパスで'
      ]
    ...
    earnest: {
      ojousama: ['申し訳ありません…今日はどうしても、体が動かなくて…', '稽古に身が入らなくて…申し訳ありません…'],
      delinquent: ['悪い…今日はどうしても体が動かねぇんだ…', '練習に集中できなくて…すまねぇ…'],
      cool: ['…すまない。今日は体が動かない', '…集中できない。悪いが、休ませてくれ'],
      seductive: ['ごめんなさい…今日はどうしても、体が動かなくて…', '練習に集中できないの…ごめんなさいね…'],
      composed: ['…すまない。今日はどうにも体が動かなくてさ', '…集中できないんだ。…悪いね'],
      _default: [
    ...
    emotional: {
      ojousama: ['もう…無理です…稽古など、できません…', '出していただけないのに、稽古をして…何になるのでしょう…'],
      delinquent: ['もう無理だ…練習なんかできねぇよ…', '出してもらえねぇのに練習して…何になんだよ…'],
      cool: ['…もう無理だ。練習はしない', '…出ないのに練習して、何になる'],
      polite: ['もう…無理です…練習なんて、できません…', '出していただけないのに練習して…何になるんですか…'],
      composed: ['…もう無理だよ。…今日は、やらない', '…出してもらえないのに練習して。…何になるのかな'],
      _default: [
        'もう無理…練習なんてできない…',
  ...
  shy: {
    ojousama: ['あの…わたくし…これは、納得できません…'],
    delinquent: ['あの…その…これは、納得できねぇっす…'],
    cool: ['…あの。…これは、納得できない'],
    seductive: ['あの…ごめんなさい…これは、納得できないの…'],
    composed: ['…言いにくいんだけど。…これは、納得できないな'],
    polite: [
      'あ、あの…これは、納得できません…'
    ]
  },
  ...
  S_grumble: {
    ...
    bold: {
      ojousama: ['（「なぜわたくしたちがこんな扱いを受けねばならないの」と控室で声を張っている）'],
      delinquent: ['（「なんであたしらがこんな扱い受けなきゃなんねぇんだよ」とロッカーで吠えている）'],
      cool: ['（「…この扱いは筋が通らない」と低く言い放ち、周囲が黙り込んだ）'],
      seductive: ['（「わたしたち、ずいぶん軽く見られてるのね」と笑みを崩さずに言い放っている）'],
      composed: ['（「…この扱いは、さすがに通らないよ」と静かに言い切り、場が凍りついた）'],
      _default: [
        '（「なんで私たちがこんな扱い受けなきゃいけないんだ」と大声で言っている）'
      ]
    },
    quiet: {
      ojousama: ['（一言も発しないまま、その静けさが控室を重くしている）'],
      delinquent: ['（何も言わず壁にもたれているが、その空気に誰も近づけない）'],
      cool: ['（無言のまま動かず、周囲だけが落ち着かなくなっている）'],
      polite: ['（黙って頭を下げるだけで、その沈黙が周囲を不安にさせている）'],
      composed: ['（何も言わないが、その静けさがかえってロッカーを重くしている）'],
      _default: [
        '（黙っているが、その沈黙がかえって周囲を不安にさせている）'
      ]
    },
    easygoing: {
      delinquent: ['（いつもの軽口が消え、「なぁ、ちょっとさぁ…」と珍しく愚痴をこぼしている）'],
      cool: ['（いつもの軽さが消え、「…ちょっと、さ」とだけ漏らして黙り込んだ）'],
      seductive: ['（笑顔が消え、「ねえ…ちょっと聞いてよ」と同僚に愚痴をこぼしている）'],
      composed: ['（いつもの飄々とした顔が消え、「…ちょっとさ」と珍しく愚痴をこぼしている）'],
      _default: [
        '（いつもの笑顔が消え、「ちょっとさぁ…」と珍しく愚痴をこぼしている）'
      ]
    },
    earnest: {
      ojousama: ['（「わたくし、このままでよろしいのでしょうか」と後輩に弱音を漏らしている）'],
      delinquent: ['（「あたし、このままでいいのかな…」と後輩に珍しく弱音を吐いている）'],
      cool: ['（「…このままでいいのか」と、後輩にだけ短く漏らしている）'],
      seductive: ['（「わたし、このままでいいのかしら」と後輩に弱音を漏らしている）'],
      polite: ['（「わたし、このままでいいんでしょうか…」と後輩に弱音をこぼしている）'],
      composed: ['（「…このままでいいのかな」と、後輩相手に珍しく弱音を漏らしている）'],
      _default: [
        '（「自分、このままでいいんですかね…」と後輩に弱音を吐いている）'
      ]
    },
    emotional: {
      ojousama: ['（目を潤ませて「もう限界かもしれません」と仲間に打ち明けている）'],
      delinquent: ['（目を赤くして「もう限界かもしんねぇ」と仲間にこぼしている）'],
      cool: ['（「…もう限界かもしれない」と、声を殺して仲間に漏らしている）'],
      polite: ['（涙をこらえながら「もう限界かもしれません」と仲間に打ち明けている）'],
      composed: ['（感情を押し殺した声で「…もう限界かもね」と仲間にだけ漏らしている）'],
      _default: [
  ...
  shy: {
    ojousama: ['あの…わたくし…少しだけ、不満がございます…'],
    delinquent: ['あの…すんません…ちょっと、不満があるんす…'],
    cool: ['…あの。…少し、不満がある'],
    seductive: ['あの…ごめんなさい…少し、不満があるの…'],
    composed: ['…言いにくいんだけど。…少し、不満があってさ'],
    polite: [
      'すみません…少し、不満があります…'
    ]
  },
  ...
  S_sns: {
    ...
    bold: {
      ojousama: ['（SNSに「このまま終わるつもりはございません」と宣言めいた投稿）'],
      delinquent: ['（SNSに「このまま終わる気はねぇから」と宣戦布告じみた投稿）'],
      cool: ['（SNSに「まだ終わらない」とだけ投稿。ファンがざわついている）'],
      seductive: ['（SNSに「このまま終わるつもりはないの。楽しみにしてて」と投稿）'],
      composed: ['（SNSに「…このまま終わるつもりはないよ」と静かな宣言を投稿）'],
      _default: [
        '（SNSに「このまま終わるつもりはない」と宣言的な投稿）'
      ]
    },
    quiet: {
      ojousama: ['（SNSに白い花の写真だけを投稿。ファンの間で憶測が飛び交っている）'],
      delinquent: ['（SNSに「…」とだけ投稿。何も語らないぶん、ファンがざわついている）'],
      cool: ['（SNSに点を三つ置いただけの投稿。ファンの憶測だけが広がっていく）'],
      polite: ['（SNSに「…すみません」とだけ投稿。ファンの間で憶測が広がっている）'],
      composed: ['（SNSに何も書かず、夜の窓の写真だけを投稿。ファンがざわついている）'],
      _default: [
        '（SNSに「…」とだけ投稿。ファンの間で憶測が広がっている）'
      ]
    },
    easygoing: {
      delinquent: ['（SNSに「最近ちょい考えることあってさ」と珍しく真面目な投稿）'],
      cool: ['（SNSに「…最近、考えることがある」と珍しく本音めいた投稿）'],
      seductive: ['（SNSに「最近ね、ちょっと考えることがあるの」と珍しく素の投稿）'],
      composed: ['（SNSに「…最近、少し考えることがあってね」と珍しく本音めいた投稿）'],
      _default: [
        '（SNSに「最近ちょっと考えることがあってー」と珍しく真面目な投稿）'
      ]
    },
    earnest: {
      ojousama: ['（SNSに「わたくしは本当に必要とされているのでしょうか」と率直な投稿）'],
      delinquent: ['（SNSに「あたし、ここで本当に必要とされてんのかな」と率直な投稿）'],
      cool: ['（SNSに「…必要とされているのか、わからない」と短く投稿）'],
      seductive: ['（SNSに「わたし、ここで必要とされているのかしら」と率直な投稿）'],
      polite: ['（SNSに「わたしは本当にここで必要とされているんでしょうか」と率直な投稿）'],
      composed: ['（SNSに「…私はここで必要とされてるのかな」と、珍しく率直な投稿）'],
      _default: [
        '（SNSに「自分は本当にここで必要とされているのか」と率直な投稿）'
      ]
    },
    emotional: {
      ojousama: ['（SNSに涙の絵文字をひとつ添えて「…もう、限界かもしれません」と投稿。騒ぎが広がっている）'],
      delinquent: ['（SNSに涙の絵文字と「もう無理かもしんねぇ」と投稿。炎上し始めている）'],
      cool: ['（SNSに涙の絵文字ひとつと「…もう無理かもしれない」と投稿。騒ぎが広がっている）'],
      polite: ['（SNSに涙の絵文字と「もう駄目かもしれません」と投稿。炎上し始めている）'],
      composed: ['（SNSに涙の絵文字と「…もう駄目かもしれないね」と投稿。静かな文面だけに騒ぎが大きくなっている）'],
      _default: [
  ...
  shy: {
    ojousama: ['あの…SNSで、あんなふうに書かれてしまって…'],
    delinquent: ['あの…SNSで、あんな風に書かれちまって…'],
    cool: ['…あの。…SNSで、あんなふうに書かれてしまって'],
    seductive: ['え、SNSで…あんなふうに書かれてしまって…'],
    composed: ['…SNSでね。…あんなふうに書かれてしまって'],
    polite: [
