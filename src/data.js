...
const ALL_CHARS = [
  ...
  {id:14,name:'黒江舞',h:159,pw:48,sp:52,te:76,st:58,mn:67,style:'Submission',role:'Heel',pot:{pw:122,sp:128,te:159,st:135,mn:147},traits:['ヒール適性','早熟'],personality:'shy',archetype:'normal'},
  ...
  {id:21,name:'木ノ内幸音',h:164,pw:66,sp:53,te:53,st:68,mn:67,style:'Allround',role:'Babyface',pot:{pw:146,sp:129,te:129,st:148,mn:147},traits:['ヒール適性','ムードメーカー','華'],personality:'earnest',archetype:'polite'},
  ...
  {id:34,name:'北畠吉乃',h:162,pw:68,sp:72,te:84,st:72,mn:69,style:'Submission',role:'Neutral',pot:{pw:148,sp:154,te:169,st:154,mn:150},traits:['破天荒','早熟','努力家'],personality:'easygoing',archetype:'normal'},
...
const RIVALRY_CONFRONTATION_LINES = {
  ...
  attacker: {
    normal: {
      _default: ['今日こそ、決着をつける', 'この因縁、今夜終わりにしよう', 'あなたを超える。今日、ここで'],
    ...
    bold: {
      _default: ['逃がさない。今日ここで決着だ', '何度やっても結果は同じだ。かかってこい'],
  ...
  defender: {
    ...
    bold: {
      _default: ['来い。全力で迎え撃つ', '何度でも返り討ちにしてやる'],
      ojousama: ['全力でお迎えしますわ'],
  ...
  fateAttacker: {
    ...
    bold: {
      _default: ['何度も戦った。でも今日が最後だ', 'この物語の最終章、始めよう'],
      cool: ['……最後だ。全てを出す'],
    },
    quiet: { _default: ['………（深く息を吸い、一歩前に出る）'] },
    shy: { _default: ['最後…だから…全力で…行きます…！'] },
  ...
  fateDefender: {
    ...
    bold: {
      _default: ['わかっている。だから全力で来なさい', '最後にふさわしい戦いを見せよう'],
      cool: ['……全力で来い'],
    },
    quiet: { _default: ['………（小さく微笑み、構える）'] },
    shy: { _default: ['…うん…全力で…行くね…'] },
...
const RIVALRY_CONFRONTATION_LINES_70 = {
  ...
  attacker: {
    ...
    bold: {
      _default: ['何度夢に見たことか。お前を倒す、この瞬間を', 'もう後がない。ここで決める'],
  ...
  defender: {
    ...
    bold: {
      _default: ['……同感だ。だから本気で行く', '夢で終わらせてやろう'],
...
const RIVALRY_CONFRONTATION_LINES_90 = {
  ...
  attacker: {
    ...
    bold: {
      _default: ['全てを賭ける。残らず全てを', '……行くぞ。最後の戦いだ'],
      cool: ['……全てを賭ける'],
    },
    quiet: {
...
const WEEKLY_STORY_TICKER = {
  ...
  awakening: {
    ...
    bold: {
      _default: [
        '{nameB}が{nameA}に詰め寄った。「いい加減にしろ！ お前がそのつもりなら、全力で叩き潰す！」',
        '{nameB}が{nameA}を指差した。「もう黙っていられない。受けて立つ！」',
      ],
    ...
    shy: { _default: ['「ずっと仲間だと思ってた。でも……あなたにとって私はただの邪魔者なんでしょう」——{nameB}の声が震えている', '{nameB}が震える声で{nameA}に告げた。「も、もう…黙って見てられない…です…！」'] },
    easygoing: {
...
const UPSET_RIVALRY_LINES = {
  ...
  loserLines: {
    ...
    bold: {
      _default: ['認めない……！ こんな結果は認めない……！', 'ありえない……こんなことが……！'],
