...
const ALL_COACHES = [
  ...
  {id:32, name:'巌流 正道',           emoji:'🐯', hasPortrait:false,
   ...
   desc:'元重量級格闘家のパワー系最高峰。実戦で通用する力を最短で身につけさせる。',
   profile:'柔道重量級で全日本選手権を制した後、総合格闘技に転身しヘビー級で無類の強さを見せた生粋のパワーファイター。現役引退後は独自のパワー理論と格闘技指導で磨いた実戦メソッドを体系化し、最高峰のパワー系コーチとして名を馳せる。その指導を受けた選手は例外なくパワーで試合を支配するようになると言われる。鋭い眼光に反して弟子思いの人情家。「力とは、覚悟の結晶だ」と説く。'},
