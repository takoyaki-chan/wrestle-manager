...
// challenge-request-spec-v0.1 Phase 5(2026-07-17細分化): 受諾時スタンス(hostile/respectful)に加え、
// 試合結果(win/lose/draw、相手陣=teamB視点)でも分岐。性格(personality)ではなくarchetype軸(6種)で統一。
// stance が取れない旧呼び出し(受諾スタンスのみ)との互換のため _accept はそのまま残す。
const CHALLENGE_REQUEST_OPPONENT_REACTIONS = {
  composed: {
    ...
    win: ['やはり、受けて正解だった。', 'この程度は、想定の内だ。'],
    lose: ['……力及ばず、か。次は違う。', '負けは負けだ。しかし、悔いはない。'],
    draw: ['決着はまた次だ。悪くない一戦だった。', '痛み分けか。これはこれで、収穫はあった。'],
  },
  ojousama: {
    _accept: [
    ...
    win: ['ほら、申し上げた通りですわ。', 'お受けして正解でしたわね、ふふ。'],
    lose: ['……悔しいですけれど、これも経験ですわ。', '負けを認めるのも、淑女のたしなみですの。'],
    draw: ['痛み分け、ですのね。次こそは勝たせてもらいますわ。', '決着つかずとは……もどかしいですわ。'],
  },
  polite: {
    _accept: [
    ...
    win: ['お受けして良かったです。ありがとうございました。', '全力を尽くした結果です。感謝しています。'],
    lose: ['力及ばず、申し訳ありません。次に活かします。', '悔しいですが、これが今の実力です。'],
    draw: ['決着つかずでしたが、良い試合でした。', '痛み分けとのこと。次の機会を待ちます。'],
  },
  seductive: {
    _accept: [
    ...
    win: ['ね、言ったでしょ。受けて正解だったって。', 'ふふ、やっぱり私を選んで正解よ。'],
    lose: ['あら……今日はあなたに華を持たせてあげる。', '悔しいけど、負けも悪くない気分よ。'],
    draw: ['決着つかず、ね。じれったいけど……嫌いじゃないわ。', '痛み分けか。続きはまた今度、しましょう?'],
  },
  delinquent: {
    _accept: [
    ...
    win: ['言った通りだろ、受けて正解だったぜ。', '上等、って言った通りになったな。'],
    lose: ['ちっ……今日のところは負けを認めてやるよ。', '悔しいけど、力及ばずだ。次は絶対勝つ。'],
    draw: ['決着つかずか。中途半端だな、こりゃ。', '痛み分けって柄じゃねぇんだけどな。'],
  },
  cool: {
    _accept: ['……受ける。', '……望むところ。', '……来い。リングで答える。'],
    win: ['……当然だ。', '……勝つと言った。'],
    lose: ['……そうか。', '……負けは、認める。'],
    draw: ['……引き分けか。', '……決着は、また。'],
  },
  normal: {
    ...
    win: ['受けて正解でした。全力を出せた試合です。', 'やはり、受けるべき試合でした。'],
    lose: ['力及ばず、悔しいです。次は違う結果を。', '負けは負けです。でも後悔はありません。'],
    draw: ['決着つかず、でしたが良い経験になりました。', '痛み分け。次はもっと踏み込みます。'],
  }
};
