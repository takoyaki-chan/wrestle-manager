...
const COMMON1_LINES = {
  ...
  // リーダーの一言（アーキタイプ別 1 件）
  leaderDemand: {
    AUTHORITY: ['揉めるなら、リングで決めろ。それがうちの流儀だ。'],
    BOND:      ['練習の延長で組ませようか。お互い、悪く思わないでほしい。'],
    MERIT:     ['序列の話なら、数字で見せた方が早い。組んでくれ。'],
    HEEL:      ['内輪揉めも興行になる。客の前で潰し合え。'],
    FACE:      ['切磋琢磨の試合として組みたい。本気でやってくれ。'],
    COMBAT:    ['口で決まらないなら、殴って決めるしかねぇだろ。'],
    _any:      ['この件、リングで片付けたい。'],
  },
  resultLeader: {
