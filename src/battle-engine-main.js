...
const CUTIN_LINES = {
  atk: {
    normal: {
      standard:["いくよ！","まだまだ！","負けないから！","ここからよ！"],
    ...
    bold: {
      standard:["まだまだっ！","ここからが本番よっ！","逃がさないわよ！","受けてみなさい！"],
    ...
    quiet: {
      standard:["…まだ、終わらない","…ここからよ","…負けるわけにはいかない","…見ていて"],
    ...
    earnest: {
      standard:["絶対に…勝つ！","ここで引くわけにはいかない！","全力で…いく！","諦めない…！"],
    ...
    emotional: {
      standard:["負けたくないっ…！","絶対に…絶対にっ…！","うぅっ…でも、負けないっ…！","こんなところで…終われないっ！"],
    ...
    easygoing: {
      standard:["あはは、楽しくなってきた！","いい試合にしようよ！","まだまだいけるよ〜！","本気出しちゃうよ？"],
    ...
    shy: {
      standard:["あ、あの…いきますっ…!","わ、わたし…まだまだ…!","ま、負けたくないから…!","こ、ここから…ですっ…!"],
  ...
  climax: {
    normal:{ standard:["（…ここからだ）","（負けない…！）"],polite:["（…ここからです）","（負けません…！）"],seductive:["（…ここから、よ）","（負けないわ…）"],delinquent:["（…ここからだぜ）","（負けねえ…！）"],ojousama:["（…ここからですわ）","（負けませんわ…！）"],cool:["（…ここから）","（…負けない）"],composed:["（…ここから、だね）","（…負けない、よ）"] },
    bold:{ standard:["（ここからが、あたしの時間！）","（さあ…決めにいく）"],polite:["（ここからです…ここからが、わたしの時間）","（さあ…決めさせていただきます）"],seductive:["（ここからよ…わたしの時間が、始まるの）","（さあ…決めてあげる）"],delinquent:["（ここからだ…あたしの時間だぜ）","（さあ…決めてやる）"],ojousama:["（ここからが…わたくしの時間ですわ）","（さあ…幕引きにしてさしあげますわ）"],cool:["（…ここから、あたしの時間）","（…決めにいく）"],composed:["（…ここから、あたしの時間だね）","（…さあ、決めにいこうか）"] },
    quiet:{ standard:["（…集中。今だけは、何も考えなくていい）","（…身体が軽い。いける）"],polite:["（…集中。今だけは、何も）","（…身体が軽い。いけます）"],seductive:["（…集中…今だけは、何も）","（…身体が軽い…いけるわ）"],delinquent:["（…集中。余計なこと考えるな）","（…体が軽い。いけるぜ）"],ojousama:["（…集中ですわ。今だけは何も）","（…身体が軽い…いけますの）"],cool:["（……集中）","（……いける）"],composed:["（…集中、だね。今は何も考えなくていい）","（…身体が軽いな…いける）"] },
    earnest:{ standard:["（ここまで来た…あとは、出し切るだけ）","（全部…全部出し切る）"],polite:["（ここまで来ました…あとは、出し切るだけ）","（全部…全部出し切ります）"],seductive:["（ここまで来たわ…あとは、出し切るだけ）","（全部…全部出し切るの）"],delinquent:["（ここまで来たんだ…あとは出し切るだけだ）","（全部…全部ぶつけてやる）"],ojousama:["（ここまで参りましたの…あとは出し切るのみ）","（全て…全て懸けますわ）"],cool:["（…ここまで来た）","（…全部、出す）"],composed:["（…ここまで来たんだ…あとは出し切るだけ、だね）","（…全部、出し切るよ）"] },
    emotional:{ standard:["（胸が苦しい…でも、この痛みが、生きてる証だから）","（お願い、身体…もう少しだけ動いて）"],polite:["（胸が苦しい…でも、この痛みが、生きてる証です）","（お願いします、身体…もう少しだけ）"],seductive:["（胸が苦しい…でも、この痛みが、生きてる証よ）","（お願い…身体、もう少しだけ、動いて）"],delinquent:["（胸が苦しい…けど、これが生きてる証だ）","（頼むぞ身体…もうちょい動いてくれ）"],ojousama:["（胸が苦しい…けれど、この痛みが生きてる証ですの）","（お願いですわ身体…もう少しだけ）"],cool:["（…胸が苦しい…でも）","（…身体、もう少しだけ）"],composed:["（…胸が苦しいな…でも、この痛みが生きてる証だから）","（…お願い、身体…もう少しだけ、動いてね）"] },
    easygoing:{ standard:["（わくわくする…この瞬間が一番好き）","（最高の試合にしよう！）"],polite:["（わくわくします…この瞬間が一番好き）","（最高の試合にしましょう！）"],seductive:["（わくわくしちゃう…この瞬間が好き♪）","（最高の試合にしましょ？）"],delinquent:["（わくわくするぜ…この瞬間が一番好きだ）","（最高の試合にしようぜ！）"],ojousama:["（わくわくいたしますわ…この瞬間が一番）","（最高の試合にいたしましょう！）"],cool:["（…わくわくする）","（…最高の試合に）"],composed:["（…わくわくするな…この瞬間が一番好き）","（…最高の試合にしよう、ね）"] },
    shy:{ standard:["（…ま、まだ…いけるはず…!）","（こ、ここで…決めなきゃ…!）"],polite:["（…ま、まだ…いけます…!）","（こ、ここで…決めないと…!）"],seductive:["（…ま、まだ…これから、だから…）","（…わ、私だって…本気なんだから…）"],delinquent:["（…ま、まだだ…ここからだ…!）","（…こ、ここで…決める…っ!）"],ojousama:["（…ま、まだですわ…ここからですの…!）","（…こ、ここで決めなくては…!）"],cool:["（…ま、まだ…）","（…こ、ここで…決める…）"],composed:["（…ま、まだ、いけるよ…）","（…こ、ここで、決めなきゃ…）"] }
  },
  bigmove: {
    normal:{ standard:["いくよ…これで決める！","ここで…終わりだ！","全部出し切る…！"],polite:["いきます…これで、決めさせてもらいます！","ここで…終わらせます！","全力で…行きます！"],seductive:["ふふ…もう逃がさないわよ？","これで終わりよ…覚悟しなさい","さあ…これでフィナーレよ"],delinquent:["おらぁっ！ これで終わりだ！","ぶっ飛ばしてやる！","オマエの負けだ…くらえ！"],ojousama:["これでお仕舞い…覚悟なさい","…最後の一撃！","これで終幕よ…！"],cool:["…決める","…これで、終わり","…いく"],composed:["…いくよ、これで決めるね","…ここで、終わり、かな","…全部、出し切るよ"] },
    earnest:{ standard:["絶対に…ここで決める！","全力で…いきます！","負けたくない…だから…！"],polite:["お願いします…この一撃に全てを…！","ここで…決めさせてください！","全身全霊で…行きますっ！"],seductive:["ふふ…本気で抱きしめてあげる","逃さないわ…最後まで","あなたの全部…もらうわよ"],delinquent:["根性見せてやる…いくぞぉ！","ここで決めなきゃ意味ねえ！","全部ぶつけてやる…！"],ojousama:["この一撃に…全てを懸けますわ！","真剣勝負ですわ…参りますわよ！","覚悟はよろしくて？ いきますわ！"],cool:["…全部、出す","…ここで決める。必ず","…負けない。絶対に"],composed:["…絶対に、ここで決めるよ","…全力で、いくね","…負けたくない、から…いく"] },
    bold:{ standard:["さあ…終わらせるわよっ！","見せてあげる…わたしの全力！","思いっきりいくわよっ！！"],polite:["さあ…決めさせていただきます！","見ていてください…最高の一撃を！","覚悟してくださいね…いきますよ！"],seductive:["うふ…壊れちゃっても知らないわよ？","最後よ…たっぷり味わいなさい","さあ…身体で教えてあげる"],delinquent:["ぶちかます！","もう終わりだ…沈めてやる！","これで最後だ…覚悟しろよ！"],ojousama:["フィナーレですわ…！","さあ…ボロ雑巾にしてさしあげますわ！","潰れなさいっ…！"],cool:["…終わりだ","…沈め","…これが、あたしの全部"],composed:["…終わらせるよ、ゆっくりね","…見ていて…わたしの全力","…覚悟してね…最高の一発"] },
    easygoing:{ standard:["よーし、ここで決めちゃおう！","いっくよー！ 最後の大技！","えへへ…全力いくよー！"],polite:["えへへ…ここで決めちゃいますね！","いきますよー！ 最後です！","全力でいかせてもらいます！"],seductive:["ふふ…そろそろ大詰めよ♪","最後のプレゼント…受け取って？","ねえ…もう諦めちゃいなさい♪"],delinquent:["それじゃ！ トドメってやつだ！","っへ！ これでシメだ！","悪いけど…終わりだよっ！"],ojousama:["さーて！ 仕上げですわ〜！","うふふ、締めにいきますわよ！","楽しかったですわ…でもここまでですわ！"],cool:["…ん、いくよ","…そろそろ終わりかな","…決めちゃう"],composed:["…よーし、ここで決めちゃおうかな","…いっくよ〜、最後の大技","…えへへ、全力いくね"] },
    quiet:{ standard:["……いく","……これで","……終わりだ"],polite:["……いきます","……これで、終わりです","……決めます"],seductive:["……もう、逃げられないわよ","……最後よ","……終わりにしてあげる"],delinquent:["……沈め","……終わりだ","……いくぞ"],ojousama:["……参りますわ","……終わりですわ","……覚悟なさい"],cool:["……","…………いく","……終わる"],composed:["……いくよ","……これで、ね","……終わり、だよ"] },
    shy:{ standard:["あ、あの…いきます…！","こ、ここで…決めます…！","が、頑張ります…！"],polite:["す、すみません…全力でいきます…！","こ、ここで…決めさせてください…！","お、思いっきり…やります…！"],seductive:["あの…もう…逃がさない、から…","ごめんね…でも…終わりにするね…","わ、私だって…本気なんだから…"],delinquent:["い、いくぞ…こ、この野郎…！","て、てめえ…覚悟しろ…！","ぶ、ぶっ飛ばしてやる…！"],ojousama:["あ、あの…仕舞いにさせていただきますわ…！","し、失礼しますわ…全力で…！","お、お覚悟を…！"],cool:["…い、いく","…こ、ここで","…が、頑張る…"],composed:["…あ、あの…いくよ…","…こ、ここで…決めるね…","…が、頑張るよ…"] },
    emotional:{ standard:["うぅっ…絶対に…決めるんだ…！","泣かない…泣かないから…いくよ！","ここで…ここでっ…！"],polite:["うぅ…お願いです…決めさせてください…！","ここで…ここで終わらせますっ…！","泣いてる場合じゃ…いきます…！"],seductive:["もう…我慢できない…壊しちゃうわよ…！","あぁ…最後よ…感じなさい…！","キャハハッ！…終わらせるわよっ…！"],delinquent:["くそぉ…絶対ぶっ飛ばす…！","うぅっ…こんちくしょう…いくぞ！","泣いてねえ…泣いてねえよ…！"],ojousama:["うぅ…ここで…ここで決めますわ…！","泣いてなど…いきますわよ…！","お覚悟を…っ…！"],cool:["…っ…いく","…泣かない…決める","…っ…これで…終わり"],composed:["…うぅ、絶対に…決めるよ","…泣かないよ…いく、ね","…ここで、ここでっ…"] }
  }
};
...
function _getCutinLines(lineType, personality, archetype){
  ...
  return byP[archetype] || byP['standard'] || null;
}
