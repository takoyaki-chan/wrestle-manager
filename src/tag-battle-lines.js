...
const HOT_TAG_LINES = {
  ...
  polite: {
    ...
    bold: ["待っていましたっ！","私の番ですっ！","ようやく回ってきましたね！"],
    easygoing: ["はーい、交代しますね〜！","お疲れさまです♪ いきますね","ここからは私の出番です♪"],
    quiet: ["…交代します","…来ました","…任せてください"],
    shy: ["が、頑張りますっ…！","こ、交代します…っ","い、行ってきますっ…！"],
    emotional: ["絶対…勝ちますっ…！","お疲れさまっ…あとは私が…！","任せてくださいっ…絶対に…！"],
  },
  seductive: {
    normal: ["任せて…いいわよ","交代よ","ここからは私の番ね"],
    earnest: ["お疲れさま…あとは任せて","よく耐えたわね…交代よ","ここからは私が背負うわ"],
    bold: ["待ちくたびれたわ","私の番よ","ようやく回ってきたわね"],
    easygoing: ["はぁい、交代ね♪","お疲れさま…あとは任せて♪","ここからは私の時間よ♪"],
    quiet: ["…交代、よ","…来たわ","…任せて、いい"],
    shy: ["が、頑張る…から…","こ、交代…ね…?","い、行ってくる…わ…"],
    emotional: ["絶対…勝つわ…！","お疲れさま…あとは私が…！","任せて…絶対に、よ…！"],
  },
  delinquent: {
    normal: ["任せときな！","交代だ！","ここからは私が行く！"],
    earnest: ["お疲れさん、あとは任せろ！","よく守ったな、交代だ！","ここからはあたしが背負うぜ！"],
    bold: ["待ってたぜ！","私の番だ！","ようやく回ってきやがった！"],
    easygoing: ["はいはい、交代な〜！","お疲れさん♪ 私いくぜ","ここからは私の出番だ♪"],
    quiet: ["…交代だ","…来たぜ","…任せときな"],
  ...
  ojousama: {
    ...
    earnest: ["お疲れさまですわ、お任せを！","よく耐えました、交代ですわ！","ここからはわたくしが引き継ぎますわ！"],
...
const DOUBLE_TEAM_LINES = {
  standard: {
    ...
    bold: ["二人で決める！","合わせて、行くぞ！","逃がさない、そっち頼む！"],
  ...
  seductive: {
    ...
    bold: ["二人で決めるわよ","合わせなさい","逃がさないわ、そっちは任せたわ"],
  ...
  ojousama: {
    ...
    earnest: ["ご一緒に参りますわ！","タイミングを合わせますわ！","二人で決めますわ！"],
...
const TAG_MATCH_WIN_LINES = {
  ...
  delinquent: {
    ...
    bold: [
      "やったな{partner}！ 私らが組みゃ、負ける気がしねえ！",
      "見たかよ！ {partner}と私のタッグ、最強だぜ！",
    ],
    easygoing: [
      "{partner}〜お疲れさん！ 私ら息ぴったりだったろ？",
...
const TAG_MATCH_LOSS_LINES = {
  ...
  seductive: {
    normal: [
      "{partner}…ごめんなさい。私が決めきれてたら…",
      "悔しいわね、{partner}。次は絶対、勝つわよ。",
    ],
    earnest: [
      "{partner}…私の力不足よ。あなたを勝たせられなかった…",
      "ここまで繋いでくれたのに…ごめんなさい、{partner}。",
    ],
    bold: [
      "私のミスよ、{partner}…悪いわね。でも次は絶対、返すわ。",
  ...
  delinquent: {
    ...
    bold: [
      "くそっ…私のミスだ、{partner}。次は絶対、返してやる。",
      "このまま終われるかよ…{partner}、次は倍返しだ！",
    ],
    easygoing: [
      "{partner}〜わりぃ…私、決められちった…",
  ...
  composed: {
    ...
    emotional: [
      "…{partner}、悪い。私が弱かった。…それだけだ。",
      "…次は、こうはいかない。{partner}、もう一回だけ付き合って。",
    ],
  },
};
