...
| quadrennial-ppv-tournament-spec-v0.1.md | 4年に一度のPPVトーナメント**「天頂戦」**(C-6・season%4==0・16名シングルエリミ15試合・全試合ビッグマッチルール・消耗持ち越し・称号効果なし・UIクライムライン型・準決勝以上2:3矩形アッパー・§6.5関係性ドラマ(文脈前提/下限0)・エントリー=特別招待2+団体枠5/4/3/2・仮エンブレム=image/emblem-tenchosen.png、v0.5 DRAFT・未実装 2026-07-18) |
