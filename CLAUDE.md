...
| quadrennial-ppv-tournament-spec-v0.1.md | 4年に一度のPPVトーナメント(C-6・season%4==0・16名シングルエリミ15試合・全試合ビッグマッチルール・消耗持ち越し・称号効果なし・UIクライムライン型確定・**大会名は和名**・準決勝以上2:3矩形アッパー・§6.5関係性ドラマ、v0.3 DRAFT・未実装 2026-07-18) |
