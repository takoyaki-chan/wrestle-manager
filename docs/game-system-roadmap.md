...
| 3 | 挑戦状イベントの廃止 | 小 | ✅ 完了 |
| 4 | 「世界王者」名称の見直し | 小 | 未着手 |
| 5 | タイトルマッチを12週に1回（クォーター末）に制限 | 中 | 未着手 |
| 6 | チャンピオンの集客ボーナス | 小 | 未着手 |
| 7 | 乱入マッチイベント | 中 | 未着手 |
| 8 | フレーバーイベント（雑誌取材・TV出演） | 中 | 未着手 |
...
- 2026-02-24 セッション9: ランキングchampionScore削除、ツールチップ追加、挑戦状イベント廃止。世界観演出システム・殿堂入りシステム・選手ライフサイクル改修をロードマップに新設。
