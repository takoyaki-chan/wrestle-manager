...
> 最終更新: 2026-03-09（相関図リニューアル Phase 6v2 + スナップショット通知システム + 施設システム廃止 Phase E 完了）
...
| 選手間関係性システム（bond/rivalry） | 高 | **Phase 1〜6v2 実装済み**（データ基盤・試合結果反映・団体運営・ケアアクション反映・ライバル称号統合・相関図UI・相関図リニューアル）。specs/relationship-system-spec-v0.2.md |
| ライバルストーリー自動生成 | 高 | 未設計 |
