...
- **§2.1 M-10 rivalryリセット**: 因縁決着時のrivalry `-8~-5` 削減→`0~10`リセットに変更。感動の「白紙」体験を実現
- **§2.2 M-14 宿命の決着**: 新イベント追加（rivalry80+/bond60+/MQ75+でライバルかつ親友の決着）。rivalry `0~5` リセット + bond +5〜+10
- **§4.1 knownRival フラグ**: rivalry≥40到達でフラグ立て、<10で消滅。クロス団体ライバルの関係値を保護（decay 1/3）
- **§4.3 knownRival 微小イベント**: 4週ごとにrivalry<60の旧ライバルが互いを意識（+0.3~+0.5）
- **§3.3 N-03 BF×Heel摩擦**: 同団体内のベビーフェイス×ヒール全ペアに4%/週で摩擦（bond -3~-6, rivalry +2~+4）
- **§3.1 N-01 ポジション嫉妬強化**: OVR差5以内+同スタイル条件でタイトル嫉妬ペナルティ追加（bond -5~-3, rivalry +3~+5）
- **§3.5 N-05 スランプ八つ当たり**: スランプ中の敗北後に最高bond同僚への一方的bond毀損（-4~-7）
- **§3.2 N-02 成長格差嫉妬**: ブレークスルー発生時、同団体の年齢差3以内・低OVR側からの嫉妬（bond -2~-4, rivalry +3~+5）
- **§3.4 N-04 人気追い越し**: 後輩の人気が先輩を超えた瞬間に一度だけ関係毀損（bond -3~-5, rivalry +2~+4）
- **§2.3 引退フリーズ**: 引退選手の全関係値に `frozen: true` フラグ。以降の週次decay対象外
- **§4.2 rivalry強化**: 対抗戦E-03 `+5~+10` → `+8~+12`。乱入 `+12~+18` を新設。チャンピオン×乱入者双方に適用
- 変更: engine.js, app.js
