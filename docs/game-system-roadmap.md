...
> 最終更新: 2026-04-24（モーダル統一 Phase 4 — D型(軽量ダイアログ) 6モーダルを mdl-d-* クラスに移行、feature/modal-unification → main マージ）
