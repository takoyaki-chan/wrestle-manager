...
## 新特技2種(Keisuke許可「ない特技を新たに作っていい」による新設)
...
※初案の「仕上げ職人」(大会系の開始体調+X)は**強すぎるためKeisuke裁定で廃止**(2026-08-13)。持ち手だった荒船・東雲は既存特技へ組み替え済み。
...
- grade:'B', coachingType:'sparta', gMult:1.18, observation:'C', style:'Brawler', abilities:['限界突破','闘志注入'], salary:82, hireFee:656, minOrgPop:30, age:48, gender:'男', origin:'神奈川'
- desc: 元男子プロレスラー。本気のスパーリングで壁を越えさせる。
- profile: 男子プロレスで鳴らした元レスラーで、今も現役さながらの体を保つ。教え方はただ一つ、自分が受けて立つこと。「口で教えられることは、もう全部誰かが言ってる。あとはぶつかるだけだ」。彼との稽古を越えた選手は、リングで物怖じしなくなる。

### 41. 東雲 千鶴(しののめ ちづる)🔔 — artisan B
- grade:'B', coachingType:'artisan', gMult:1.18, observation:'A', style:'Submission', abilities:['弱点克服','ステ特化TE'], salary:88, hireFee:704, minOrgPop:30, age:52, gender:'女', origin:'広島'
- desc: 元名レフェリー。至近距離で見てきた「勝負の綻び」を直す。
- profile: 二十五年間、リングの中で名勝負を裁いてきた。誰よりも近くで技の成立と失敗を見続けた目は、コーチに転じてなお衰えない。「技が決まる瞬間の音を、私は覚えています」。負け癖の正体を一度の稽古で言い当てる。
...
| 希少 | 闘志2〜3/延命2/弱克3〜4/限突3 | 闘志(37,40,52)/延命(38,42)/弱克(39,41,55,57)/限突(37,40,53) ✓(仕上げ職人廃止の組み替えで闘志・弱克が各+1) |
| 新特技 | 復帰3/結束3 | 復帰(42,56,60)/結束(47,48,49) ✓ |
