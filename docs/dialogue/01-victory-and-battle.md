...
- コード内コメント: Victory Lines (勝利セリフ) — v1.0 / キャラクタープロフィール・スタイル・ロールに基づく勝利時台詞 / 使用: VICTORY_LINES[charId] → string[]  (ランダム選択)
- 本数: 381

### 1[]

- `VICTORY_LINES.1[1]`: ごめんね。まだまだ負けられないんだ…
- `VICTORY_LINES.1[2]`: 頑張ったね。今回は私の勝ちだ。
- `VICTORY_LINES.1[3]`: …思ったよりも強かったよ

### 2[]

- `VICTORY_LINES.2[1]`: 日々の努力は裏切らない
- `VICTORY_LINES.2[2]`: 私は……まだまだ強くなれる
- `VICTORY_LINES.2[3]`: …この程度か。……話にならない。

### 3[]

- `VICTORY_LINES.3[1]`: あっ…勝てたかぁ…油断は禁物だね
- `VICTORY_LINES.3[2]`: どんな相手だって、自分の強みを生かせば勝てるんだよ
- `VICTORY_LINES.3[3]`: どんな勝ち方でも勝ちは勝ち。…ごめんなさいね

### 4[]

- `VICTORY_LINES.4[1]`: は？私が勝つのは当たり前よ？
- `VICTORY_LINES.4[2]`: 自信を無くす必要はないわよ。アンタは格上に負けたんだから
- `VICTORY_LINES.4[3]`: はぁ…はぁ…勝ったぁ

### 5[]

- `VICTORY_LINES.5[1]`: ……私の脚力ならまだまだ勝てる！
- `VICTORY_LINES.5[2]`: 今日はスピードが活かせたかなっ♪
- `VICTORY_LINES.5[3]`: よしっ、練習通り！

### 6[]

- `VICTORY_LINES.6[1]`: あ～疲れた。でもまぁ勝ったからいっか♪
- `VICTORY_LINES.6[2]`: 楽して勝てるのが一番！ 効率重視ってやつ？
- `VICTORY_LINES.6[3]`: この副ちゃんさんを、舐めないでよね～

### 7[]

- `VICTORY_LINES.7[1]`: お嬢様をお守りするために…私は強くなる！
- `VICTORY_LINES.7[2]`: 技の精度は…まだまだ磨けるわね！
- `VICTORY_LINES.7[3]`: この勝利…高階まさみの誉れです！

### 8[]

- `VICTORY_LINES.8[1]`: バスケで鍛えたフットワーク、プロレスでも使えるね！
- `VICTORY_LINES.8[2]`: 技術とかよくわかんないけど、打撃なら任せて！
- `VICTORY_LINES.8[3]`: プライドにかけて、負けるわけにはいかない！

### 9[]

- `VICTORY_LINES.9[1]`: やった～♡ 今日のカワイイ私、完全勝利じゃん♪
- `VICTORY_LINES.9[2]`: いい女は、リングでも手を抜かないの♡
- `VICTORY_LINES.9[3]`: え、調子いい日だっただけ？ …まぁいいけど♪

### 11[]

- `VICTORY_LINES.11[1]`: …あら、もう終わり？もっと苦しむ顔が見たかったのに。
- `VICTORY_LINES.11[2]`: 関節が軋む音…心地いいわ。
- `VICTORY_LINES.11[3]`: 負けて無様な姿をさらして…　いい気味ね♪

### 12[]

- `VICTORY_LINES.12[1]`: 勝った勝った♪まぁ、こんなもんだな
- `VICTORY_LINES.12[2]`: これで終わり？根性が足りないんじゃない？
- `VICTORY_LINES.12[3]`: ああっ？チビなのにパワーがある？余計なお世話だよ

### 13[]

- `VICTORY_LINES.13[1]`: ……（無言で拳を握りしめる）
- `VICTORY_LINES.13[2]`: …一撃で決める。それだけ。
- `VICTORY_LINES.13[3]`: ……次。

### 14[]

- `VICTORY_LINES.14[1]`: ふふっ…情けない悲鳴♪……最高♪
- `VICTORY_LINES.14[2]`: リングの上では…私、ちょっと違うの。わかったでしょ？
- `VICTORY_LINES.14[3]`: 優等生の私がこんなことするなんて…でも、やめられないの♡

### 15[]

- `VICTORY_LINES.15[1]`: はっはっは！ パワーで押し潰すのが一番気持ちいいぜ！
- `VICTORY_LINES.15[2]`: 何人でもまとめて相手してやるよ！
- `VICTORY_LINES.15[3]`: この体格、伊達じゃないんだよ！ どんどんかかってきな！

### 16[]

- `VICTORY_LINES.16[1]`: …まったく…身の程知らずもいいところね
- `VICTORY_LINES.16[2]`: 頂点に立つ者の重み…あなたには一生わからないでしょうね。
- `VICTORY_LINES.16[3]`: ふふ…退屈な試合だったわ。もっと楽しませてくれないかしら？

### 17[]

- `VICTORY_LINES.17[1]`: いい試合だった！ また戦おうね！
- `VICTORY_LINES.17[2]`: ふぅ、なんとかなったぁ。
- `VICTORY_LINES.17[3]`: 負け続きでも腐らなかった。…やっと報われた気がする！

### 18[]

- `VICTORY_LINES.18[1]`: ワタシに勝てないってのは、最初からわかんないかねぇ？
- `VICTORY_LINES.18[2]`: あのお嬢がうるさいし、ちゃんと勝ててよかったわ♪
- `VICTORY_LINES.18[3]`: ちょっと本気出しちまったな。…ひさびさに。

### 19[]

- `VICTORY_LINES.19[1]`: …勝利を捧げます！
- `VICTORY_LINES.19[2]`: 忠義を尽くす。それが私の生き方。
- `VICTORY_LINES.19[3]`: あなたが見ていてくれるなら、何でもできる！

### 20[]

- `VICTORY_LINES.20[1]`: 冷静に分析して、弱点を突く。それだけのことよ。
- `VICTORY_LINES.20[2]`: コツコツ磨いた関節技…やっと実を結んだわ。
- `VICTORY_LINES.20[3]`: 身体能力じゃ勝てない。だから頭を使うの。

### 21[]

- `VICTORY_LINES.21[1]`: 勝った！楽しい！いい感じ！
- `VICTORY_LINES.21[2]`: この試合、ヒールっぽかった？　えっ、そんな事無い？
- `VICTORY_LINES.21[3]`: 見てましたか！？ 私、やりましたよーっ！

### 22[]

- `VICTORY_LINES.22[1]`: でかいのは正義。押し潰されたいなら何度でも来なよ
- `VICTORY_LINES.22[2]`: 私が役に立つの、わかっただろ？
- `VICTORY_LINES.22[3]`: ラフファイト？これくらいでつべこべ言うんじゃねえよ

### 23[]

- `VICTORY_LINES.23[1]`: …勝ったの、私が？ へぇ、やるじゃん。
- `VICTORY_LINES.23[2]`: 勝つためなら何でもやるわ。
- `VICTORY_LINES.23[3]`: 空手かじっといてよかった…かも。

### 24[]

- `VICTORY_LINES.24[1]`: あたしがリーダーよ！ 文句あんの？
- `VICTORY_LINES.24[2]`: ふんっ、実力で勝ったんだから文句ないでしょ！
- `VICTORY_LINES.24[3]`: …え、まぐれじゃないって！ ちゃんと実力よ！

### 25[]

- `VICTORY_LINES.25[1]`: うっし！ パワーで潰せば何とかなるもんだ！
- `VICTORY_LINES.25[2]`: 細かいことは苦手だけどさ、勝ちは勝ちだろ？
- `VICTORY_LINES.25[3]`: ガハハ！ もっと暴れさせろよ！

### 26[]

- `VICTORY_LINES.26[1]`: 廃校寸前の学校だったけど…実力は本物だよ！
- `VICTORY_LINES.26[2]`: 堅実に、丁寧に。それが私のプロレス。
- `VICTORY_LINES.26[3]`: 努力は裏切らない。元砥石川の意地、見せたよ！

### 27[]

- `VICTORY_LINES.27[1]`: パワーもスピードもスタミナも！ 全部出し切ったよ！
- `VICTORY_LINES.27[2]`: 元砥石川の仲間たちに恥じない試合ができた！
- `VICTORY_LINES.27[3]`: タフさなら誰にも負けない。何度でも立ち上がる！

### 28[]

- `VICTORY_LINES.28[1]`: パワーとスピード…両方使えるのが私の武器！
- `VICTORY_LINES.28[2]`: 正統派ストロングスタイルが最強ってこと。ストロングってついてるでしょ？
- `VICTORY_LINES.28[3]`: 四天王？そんな風に呼ばれたことも有ったねえ

### 29[]

- `VICTORY_LINES.29[1]`: はぁ…はぁ…　いい試合だし、いい勝負だったでしょ？
- `VICTORY_LINES.29[2]`: 昔は痛めたヒザも、もう万全。怖いものなんてないよ！
- `VICTORY_LINES.29[3]`: この団体と仲間のために、私は勝ち続けるよ！

### 30[]

- `VICTORY_LINES.30[1]`: 盛り上がってきたね… まだまだいくよ！
- `VICTORY_LINES.30[2]`: やっぱり試合で勝つのは気分がいいね
- `VICTORY_LINES.30[3]`: 持って生まれたパワーと体格、活かせばけっこう勝てるもんよ

### 31[]

- `VICTORY_LINES.31[1]`: みんなの為にも自分の為にも、一つ一つの勝利が大切なの
- `VICTORY_LINES.31[2]`: はぁ…はぁ…練習の成果が出たみたい。嬉しいな。
- `VICTORY_LINES.31[3]`: 技の精度も上がってきた。まだまだ行けるかも。

### 32[]

- `VICTORY_LINES.32[1]`: 勝った！勝ったよ！
- `VICTORY_LINES.32[2]`: この勝利で、何かが吹っ切れたかも
- `VICTORY_LINES.32[3]`: 負けたくない…この気持ちが一番の武器！

### 33[]

- `VICTORY_LINES.33[1]`: いつだって、私が道を切り開く！
- `VICTORY_LINES.33[2]`: おしとやかに見える？ …リングの上では別よ。
- `VICTORY_LINES.33[3]`: 私は仲間の想いも背負っているの…負けるはずが無いわ

### 34[]

- `VICTORY_LINES.34[1]`: ……わたしの実力、さすがに伝わった？
- `VICTORY_LINES.34[2]`: …みんなに迷惑はかけられない。…結果は出さないと。
- `VICTORY_LINES.34[3]`: グラウンドは得意なの。……みんな逃げられないよ？

### 35[]

- `VICTORY_LINES.35[1]`: ツインタワー？デカいのは見ればわかるっしょｗｗｗ
- `VICTORY_LINES.35[2]`: チビは大変だねぇ？それに引き換え私は良かったｗｗ
- `VICTORY_LINES.35[3]`: ちゃんと結果は出しますよっ。それってエリートの義務だしね♪

### 36[]

- `VICTORY_LINES.36[1]`: 持って生まれた体躯であれば、活かさぬ理由はありはしない。
- `VICTORY_LINES.36[2]`: 何と呼ばれるのもかまわない。期待に応えて勝つだけだ。
- `VICTORY_LINES.36[3]`: 鍛え続けた身体と技は…十分通用すると確認できた。

### 37[]

- `VICTORY_LINES.37[1]`: 「柔の白銀」…この試合で証明できたかしら？
- `VICTORY_LINES.37[2]`: このリングの上で、ふがいない戦いは出来ないものね。
- `VICTORY_LINES.37[3]`: 強く、凛々しく、美しく。それが姫宮女子の在り方。

### 38[]

- `VICTORY_LINES.38[1]`: 「剛の芝」のパワー、その身でしかと受けていただけたかしら？
- `VICTORY_LINES.38[2]`: 手加減するなんて失礼だもの。もちろん全力で当たりましたわ。
- `VICTORY_LINES.38[3]`: 姫宮の二枚看板として…絶対に負けるわけにはいかない！

### 39[]

- `VICTORY_LINES.39[1]`: ……次期キャプテンの責任、果たせたかな。
- `VICTORY_LINES.39[2]`: コンビネーションのキレ、もっと磨いていく。
- `VICTORY_LINES.39[3]`: 寡黙？ …リングの上では拳で語るから。

### 40[]

- `VICTORY_LINES.40[1]`: 小さくても、最後まで走り切る！ それが私の持ち味！
- `VICTORY_LINES.40[2]`: 1年からレギュラー、努力で掴んだポジションだよ！
- `VICTORY_LINES.40[3]`: スタミナなら負けない…後半勝負、いつでもどうぞ！

### 41[]

- `VICTORY_LINES.41[1]`: あら？勝った？ちょっと弱すぎない？
- `VICTORY_LINES.41[2]`: 関節技で仕留めるのが、結局一番手っ取り早いよねぇ。
- `VICTORY_LINES.41[3]`: さてと、勝ったし、早く帰りたいわね

### 42[]

- `VICTORY_LINES.42[1]`: 喧嘩とおんなじで、リングの上でも強けりゃ勝つんだよ
- `VICTORY_LINES.42[2]`: ルール？ 勝てばいいのよ。手段は選ばない。
- `VICTORY_LINES.42[3]`: 実力の違い、わかったかなぁ？

### 43[]

- `VICTORY_LINES.43[1]`: パワーで押しつぶす。それだけ。
- `VICTORY_LINES.43[2]`: 頭使うのは苦手だけどさ…力なら誰にも負けない！
- `VICTORY_LINES.43[3]`: 暴れ足りない… 次の相手は？

### 44[]

- `VICTORY_LINES.44[1]`: わ、私が勝った…！？ マジで？
- `VICTORY_LINES.44[2]`: 先輩たちに追いつくために、もっと頑張る！
- `VICTORY_LINES.44[3]`: 1年生でも、やれるところ見せたよ！

### 45[]

- `VICTORY_LINES.45[1]`: ふふ…計画通り
- `VICTORY_LINES.45[2]`: 支配する側と、される側。…この結果でハッキリしたわね？
- `VICTORY_LINES.45[3]`: 力づくで分からせるのも、意外と悪くないものよね♪

### 46[]

- `VICTORY_LINES.46[1]`: はっ…はっ…ふぅ。やっぱり最後まであきらめないのが大事なのよね
- `VICTORY_LINES.46[2]`: いくつになっても強くなれるって、私もやっと分かってきたわ。
- `VICTORY_LINES.46[3]`: 応援ありがとう。次の試合も全力を尽くしますね。

### 47[]

- `VICTORY_LINES.47[1]`: 実力は見ての通りよ。伝わったかしら？
- `VICTORY_LINES.47[2]`: サブミッション技術なら…年季は関係ないわ。
- `VICTORY_LINES.47[3]`: 若手の勢い、見せてあげたわ。

### 48[]

- `VICTORY_LINES.48[1]`: 外では厳しく、家では陽気♪ …リングの上は？ もちろん全力よ！
- `VICTORY_LINES.48[2]`: わたしこれでも実力者扱いされてるのよ？あんまり舐めないでよね
- `VICTORY_LINES.48[3]`: ふぅ…調子上がってきたかな？

### 49[]

- `VICTORY_LINES.49[1]`: 井沢さんに教わったこと、しっかり活かせました…！
- `VICTORY_LINES.49[2]`: 基本から学んで、一歩ずつ。着実に強くなってみせます！
- `VICTORY_LINES.49[3]`: おっとりしてるって言われるけど…やる時はやるんです！

### 50[]

- `VICTORY_LINES.50[1]`: あらぁ～、勝っちゃった♡ ラッキー♪
- `VICTORY_LINES.50[2]`: 世渡り上手って言わないで…生き残り戦略って言って♪
- `VICTORY_LINES.50[3]`: はい、ごちそうさま♪イイ獲物って感じだったよ♪

### 51[]

- `VICTORY_LINES.51[1]`: あら…もう終わり？ もっと苦しんでくれると思ったのに♡
- `VICTORY_LINES.51[2]`: 可愛い顔が歪む瞬間…たまらないわ♡
- `VICTORY_LINES.51[3]`: 私の得意の関節技…逃げられないでしょう？

### 52[]

- `VICTORY_LINES.52[1]`: 私の経験値。そんなに舐めないで。
- `VICTORY_LINES.52[2]`: …勝てばいいのよ、勝てば。
- `VICTORY_LINES.52[3]`: 団地の生存競争は甘くないわ。

### 53[]

- `VICTORY_LINES.53[1]`: あはは！ パワーで押し切っちゃった！ テクニック？ 何それ♪
- `VICTORY_LINES.53[2]`: ズボラだけど夫婦仲は円満だよ～♪ プロレスも楽しい！
- `VICTORY_LINES.53[3]`: 年の割に？ 失礼ね！ まだまだ元気よ！

### 54[]

- `VICTORY_LINES.54[1]`: え…私が勝ったの？ 運動苦手なのに…！
- `VICTORY_LINES.54[2]`: 職場の人間関係で鍛えられた…のかも？
- `VICTORY_LINES.54[3]`: 平凡なOLでも、やればできる…んですね！

### 55[]

- `VICTORY_LINES.55[1]`: 仕事もプロレスも、全力で！
- `VICTORY_LINES.55[2]`: ふぅ……観客のみんなに実力を見せれたかな？
- `VICTORY_LINES.55[3]`: いい試合だったわ。また一つ経験になった……

### 56[]

- `VICTORY_LINES.56[1]`: ふふ…まだまだいたぶり足りないわ。
- `VICTORY_LINES.56[2]`: あまり私を舐めない事ね…
- `VICTORY_LINES.56[3]`: あなたのお陰で勝ち星が一個増えたわ。ごちそうさま♪

### 57[]

- `VICTORY_LINES.57[1]`: 元マドンナの座、必ず取り戻すわ…！
- `VICTORY_LINES.57[2]`: 策略を巡らせるのは得意なの。正面からだけが勝負じゃない。
- `VICTORY_LINES.57[3]`: このまま積み上げていけば、いずれ私が……

### 58[]

- `VICTORY_LINES.58[1]`: 後輩を守るのが先輩の務め。…負けるわけにはいかない！
- `VICTORY_LINES.58[2]`: 情に厚い？ …当然でしょ。仲間は家族よ。
- `VICTORY_LINES.58[3]`: ちゃんと勝ったし、土産話が出来るかな？

### 59[]

- `VICTORY_LINES.59[1]`: もう、誰にも負けたくない！ずっと勝ち続ける！
- `VICTORY_LINES.59[2]`: 嫉妬？ …ええそうよ。だから強くなるの！
- `VICTORY_LINES.59[3]`: 直情型って言うな！ …いや、そうだけど！

### 60[]

- `VICTORY_LINES.60[1]`: この体格とパワー…特殊な血筋のおかげかな。
- `VICTORY_LINES.60[2]`: 精神的な強さが一番の武器。何があっても折れない！
- `VICTORY_LINES.60[3]`: まだまだ成長途中。もっと強くなってみせる！

### 61[]

- `VICTORY_LINES.61[1]`: カーストトップの実力、見せつけてあげたわ♪
- `VICTORY_LINES.61[2]`: ルックスも実力も…全部持ってる私に敵うわけないでしょ？
- `VICTORY_LINES.61[3]`: ギャル3人衆のリーダーは伊達じゃないの♡

### 62[]

- `VICTORY_LINES.62[1]`: …恋する乙女を怒らせないで。
- `VICTORY_LINES.62[2]`: この威圧感…感じたでしょ？
- `VICTORY_LINES.62[3]`: 伊勢原…あんたのことは許さないから。

### 63[]

- `VICTORY_LINES.63[1]`: 立場を失っても、芯の強さは失わない…！
- `VICTORY_LINES.63[2]`: 委員長の意地、見せてやる！
- `VICTORY_LINES.63[3]`: 正しいことを貫く。それが私のプロレス。

### 64[]

- `VICTORY_LINES.64[1]`: せりかちゃんたちがいるから安心♪ あ、自力で勝った？
- `VICTORY_LINES.64[2]`: 長いものに巻かれるのも…生存戦略よ？
- `VICTORY_LINES.64[3]`: 世渡り上手って褒め言葉でしょ♪

### 65[]

- `VICTORY_LINES.65[1]`: いい試合だったね♪ …あ、本音？ もっとやれたんじゃない？
- `VICTORY_LINES.65[2]`: 人当たりいいのは仕事のスキル。毒舌はオフの特権♪
- `VICTORY_LINES.65[3]`: 勝った勝った♪　ファイトマネーで焼き肉ね♪

### 66[]

- `VICTORY_LINES.66[1]`: ふぅ…負けるわけにはいかないのよね
- `VICTORY_LINES.66[2]`: ワタシにも意地があるのよ。
- `VICTORY_LINES.66[3]`: 田村君も喜んでくれるかな？

### 67[]

- `VICTORY_LINES.67[1]`: 夢も勝利もあきらめない。
- `VICTORY_LINES.67[2]`: ピアノで培ったリズム感。この試合でも活かせたかも。
- `VICTORY_LINES.67[3]`: この闘志…今は音楽じゃなくプロレスに全部注ぐ！

### 68[]

- `VICTORY_LINES.68[1]`: 大切な人のために全力で戦う…それが私！
- `VICTORY_LINES.68[2]`: 負けず嫌いの情熱家、なめないで！
- `VICTORY_LINES.68[3]`: リョータに恥じない試合ができた…よね？

### 69[]

- `VICTORY_LINES.69[1]`: チアリーディングで鍛えたアクロバット、見てくれた？
- `VICTORY_LINES.69[2]`: レースクイーンだけど、リングでもスポットライトは譲らないわ♪
- `VICTORY_LINES.69[3]`: スピードで魅せる！ それがモナのスタイル♡

### 70[]

- `VICTORY_LINES.70[1]`: クリーニング屋の看板娘は、パワフルなのよ♪
- `VICTORY_LINES.70[2]`: 面倒見のいい姐御肌…って言ってくれる？
- `VICTORY_LINES.70[3]`: まだまだ私もいけるでしょ？

### 71[]

- `VICTORY_LINES.71[1]`: モデルの仕事もプロレスも、華やかにこなすわ♪
- `VICTORY_LINES.71[2]`: 堅実な実力が私の強み。派手さだけじゃないの。
- `VICTORY_LINES.71[3]`: 私の実力、相手に見せつけてあげたわ。

### 72[]

- `VICTORY_LINES.72[1]`: あら、怖かった？ ごめんなさいね…ふふ♡
- `VICTORY_LINES.72[2]`: 優しそうに見えたって？もちろん優しいわよ？
- `VICTORY_LINES.72[3]`: あらあら。体調が悪かったのかしら？ごめんなさいね

### 73[]

- `VICTORY_LINES.73[1]`: ああっ？ヤワな奴だなぁ？もう終わりかぁ？
- `VICTORY_LINES.73[2]`: ははっ。私にビビッて腰が引けてたなあ。それじゃ勝てないね
- `VICTORY_LINES.73[3]`: 大観衆の前でザコをいびるのも悪くないねぇ

### 74[]

- `VICTORY_LINES.74[1]`: 実力、お見せしましたわ♪
- `VICTORY_LINES.74[2]`: お淑やかに見えて、実は結構強気なんです♡
- `VICTORY_LINES.74[3]`: リングでも知的に戦うのが信条だけど、出来ていたかしら？

### 75[]

- `VICTORY_LINES.75[1]`: 私は勝つのが好きなの。試合が好きなわけじゃないわ。
- `VICTORY_LINES.75[2]`: この試合で私の魅力、見せてあげれたでしょ♪
- `VICTORY_LINES.75[3]`: 他人を蹴落とす？ …それも実力のうちよ。

### 76[]

- `VICTORY_LINES.76[1]`: はぁ・・・はぁ・・・勝ったぁ
- `VICTORY_LINES.76[2]`: よーし勝った！頑張ったぁ！
- `VICTORY_LINES.76[3]`: 私にだって譲れない戦いがあるよっ

### 77[]

- `VICTORY_LINES.77[1]`: …観察していれば、弱点は見えてくるものよ。
- `VICTORY_LINES.77[2]`: 大人びてるって言われるけど…それが私の武器かしら。
- `VICTORY_LINES.77[3]`: 知性で戦う。それが新見ゆりのスタイル。

### 78[]

- `VICTORY_LINES.78[1]`: ふう…もっと強くならないと！
- `VICTORY_LINES.78[2]`: わたしの意地、見せられたかなぁ
- `VICTORY_LINES.78[3]`: 誰が相手だって私は負けたくないのっ

### 79[]

- `VICTORY_LINES.79[1]`: きれいごと？ 笑わせないで。勝てばいいのよ。
- `VICTORY_LINES.79[2]`: ダーティ？ …それが私のスタイルだもの。
- `VICTORY_LINES.79[3]`: 手段なんて選んでたら生き残れないわ。

### 80[]

- `VICTORY_LINES.80[1]`: わ…わたし、勝てたの…？ うそ…！
- `VICTORY_LINES.80[2]`: ひ弱だけど…諦めたくないから…！
- `VICTORY_LINES.80[3]`: 明日も生きてたい…だから、今日も戦うの…！

### 81[]

- `VICTORY_LINES.81[1]`: 営業成績もプロレスも好調♪ ちょっと調子乗っちゃうかも！
- `VICTORY_LINES.81[2]`: 今日も絶好調！まだまだ伸びるよー！
- `VICTORY_LINES.81[3]`: おじさん人気？ …あ、応援ありがとうございます♡

### 82[]

- `VICTORY_LINES.82[1]`: 社内の人間関係のストレス…リングで全部ぶつける！
- `VICTORY_LINES.82[2]`: 番狂わせ？ …実力よ。見くびらないで。
- `VICTORY_LINES.82[3]`: 普段デスクワークだからって、馬鹿にするもんじゃないですよ？

### 83[]

- `VICTORY_LINES.83[1]`: 新人だけどやる気だけは負けません！ がんばりますっ！
- `VICTORY_LINES.83[2]`: 丹羽先輩に教わったこと、全部出し切った…！
- `VICTORY_LINES.83[3]`: まだまだ覚束ないけど…勝てて嬉しいですっ！

### 84[]

- `VICTORY_LINES.84[1]`: 営業の男たちに囲まれたストレス…ここで発散よ！
- `VICTORY_LINES.84[2]`: 地下プロレスで憂さ晴らし。最高のストレス解消法ね。
- `VICTORY_LINES.84[3]`: …明日からまた仕事か。でも今日はスッキリ！

### 85[]

- `VICTORY_LINES.85[1]`: ルーシーって名前、キラキラ？ …本人は普通だよ？
- `VICTORY_LINES.85[2]`: アパレル就職決まったし、卒業まで思いっきり楽しむ！
- `VICTORY_LINES.85[3]`: 彼氏にもいいとこ見せなきゃってね♪

### 86[]

- `VICTORY_LINES.86[1]`: 連戦連勝。リングでも無敗を続けたいわね
- `VICTORY_LINES.86[2]`: ストレス発散にはダーティファイトが一番ね♡
- `VICTORY_LINES.86[3]`: 試合で得たインスピレーションが、仕事にも役立つのよね♪

### 87[]

- `VICTORY_LINES.87[1]`: Danke schön! 体操で鍛えたスピード、見てくれた？
- `VICTORY_LINES.87[2]`: 金髪碧眼の美少女が地下リングに！ …自分で言うのもなんだけど♪
- `VICTORY_LINES.87[3]`: オーストリアの強化選手を舐めないでね！

### 88[]

- `VICTORY_LINES.88[1]`: 昼はOL、夜はリング…二つの顔を使い分けるの。
- `VICTORY_LINES.88[2]`: プロレスクラブのテクニシャン、なめないで。
- `VICTORY_LINES.88[3]`: 怪しげ？ …そこがいいんじゃない♡

### 89[]

- `VICTORY_LINES.89[1]`: 実家では看板娘って呼ばれてました♪赤羽ケーキ店をよろしくお願いします♪
- `VICTORY_LINES.89[2]`: こうゆうタイプの女には、絶対負けたくないのよね。
- `VICTORY_LINES.89[3]`: 東商店街の意地、見せてあげたわ！

### 90[]

- `VICTORY_LINES.90[1]`: 和菓子屋の一人娘は粘り強いのよ。
- `VICTORY_LINES.90[2]`: 絶対負けたくない…あの人の為にも！私の為にも！
- `VICTORY_LINES.90[3]`: スタミナとメンタルで勝負。努力は裏切らない！

### 91[]

- `VICTORY_LINES.91[1]`: 選手としての責任は…ちゃんと果たせたかな？
- `VICTORY_LINES.91[2]`: はぁ…はぁ…！勝った！
- `VICTORY_LINES.91[3]`: 常川高校プロレス部の名に恥じない戦いを！

### 92[]

- `VICTORY_LINES.92[1]`: サブミッション技術には自信があるの
- `VICTORY_LINES.92[2]`: 保健室の先生を舐めないでね♡
- `VICTORY_LINES.92[3]`: 相手の骨や筋を、無理な方に曲げるのが好きなの♪

### 93[]

- `VICTORY_LINES.93[1]`: …期待に応える。それだけです。
- `VICTORY_LINES.93[2]`: このリングで全力を出す。そして勝つ！それが一番嬉しいの。
- `VICTORY_LINES.93[3]`: 名門校の看板を背負って。全力で戦い続けます。

### 94[]

- `VICTORY_LINES.94[1]`: 私は私の道を行く。
- `VICTORY_LINES.94[2]`: 闇試合で鍛えた技…お上品なリングじゃ味わえないでしょ？
- `VICTORY_LINES.94[3]`: 道を踏み外した？ …これが本当の私よ。

### 95[]

- `VICTORY_LINES.95[1]`: …リングの上でも全力よ♡
- `VICTORY_LINES.95[2]`: レースクイーンのテクニシャン、見くびらないで。
- `VICTORY_LINES.95[3]`: 女は美しさと技術で勝負！

### 96[]

- `VICTORY_LINES.96[1]`: ふふっ。実力発揮。できたかな♪
- `VICTORY_LINES.96[2]`: こうゆう華やかな舞台も、悪くないわね♪
- `VICTORY_LINES.96[3]`: サークルで鍛えた体力、馬鹿にできないでしょ？

### 97[]

- `VICTORY_LINES.97[1]`: こう見えてちゃんと鍛えてるんだから、なめないでね！
- `VICTORY_LINES.97[2]`: よーし勝ったぁ！全力投球！
- `VICTORY_LINES.97[3]`: いい試合でしたっ！ありがとうございました！

### 98[]

- `VICTORY_LINES.98[1]`: このリングで、実力を発揮できた気がする
- `VICTORY_LINES.98[2]`: みんなの応援で勝てましたっ。ありがとうっ！
- `VICTORY_LINES.98[3]`: あなたの挑戦を受けてよかった。私の勝ちよ

### 99[]

- `VICTORY_LINES.99[1]`: 昔から瞬発力は褒められるんだ♪驚いたでしょ♪
- `VICTORY_LINES.99[2]`: 心の中の黒いものも力に変えて。私は勝ち続ける。
- `VICTORY_LINES.99[3]`: どう？私の力、思い知った？

### 100[]

- `VICTORY_LINES.100[1]`: あの、練習でやってきたこと、全部出せました
- `VICTORY_LINES.100[2]`: 空中技って、踏み切りの一歩が全てなんです。今日は完璧でした
- `VICTORY_LINES.100[3]`: ありがとうございます。まだまだ積み上げていきます

### 101[]

- `VICTORY_LINES.101[1]`: なんか……うまく引き出せた気がします。楽しかったですよ
- `VICTORY_LINES.101[2]`: 組み合ってみて、色々見えてくるんですよね。ほんと面白いなって
- `VICTORY_LINES.101[3]`: あはは、でも相手が強くてこそですから

### 102[]

- `VICTORY_LINES.102[1]`: …打撃で崩せれば、こんなもんかな
- `VICTORY_LINES.102[2]`: 当てるタイミングだけ見てた。あとは体が動いたよ
- `VICTORY_LINES.102[3]`: …悪くない試合だったと思う

### 103[]

- `VICTORY_LINES.103[1]`: 勝てましたが、課題は山積みです。まだ全然足りないと思っています
- `VICTORY_LINES.103[2]`: 今日はたまたま噛み合っただけで、実力を出し切れたわけじゃない
- `VICTORY_LINES.103[3]`: もっとやれます。もっと強くなれると信じています

### 104[]

- `VICTORY_LINES.104[1]`: 勝った…勝ったよ！ …うそ、嬉しい…！
- `VICTORY_LINES.104[2]`: 空中技が決まったときは、本当に気持ちいいんだっ♪
- `VICTORY_LINES.104[3]`: ダメだ、泣きそう…本当に嬉しい！

### 105[]

- `VICTORY_LINES.105[1]`: …どれだけ打ってきても、折れないよ
- `VICTORY_LINES.105[2]`: こういう試合、嫌いじゃない。ボロボロになってからが本番だからね
- `VICTORY_LINES.105[3]`: …ま、次もこれでいく

### 106[]

- `VICTORY_LINES.106[1]`: 見切ったら、あとは当てるだけ
- `VICTORY_LINES.106[2]`: 別に。普通に勝っただけ
- `VICTORY_LINES.106[3]`: もう次の試合のこと考えてる

### 107[]

- `VICTORY_LINES.107[1]`: わたしの極め技……けっこう抜けられないんです
- `VICTORY_LINES.107[2]`: あ…技の引き出しは多いって言われてるので……
- `VICTORY_LINES.107[3]`: 技数で勝負するタイプです…力には自信ないし……

### 108[]

- `VICTORY_LINES.108[1]`: 嬉しいです、本当に。あきらめないでよかった
- `VICTORY_LINES.108[2]`: 練習してきたことが、形になった気がします
- `VICTORY_LINES.108[3]`: まだ課題はありますけど、今日は少し自信になりました

### 109[]

- `VICTORY_LINES.109[1]`: わあ、勝ったー！最高です！
- `VICTORY_LINES.109[2]`: 空中技が決まった瞬間、会場がわぁってなって、もうテンション最高でした
- `VICTORY_LINES.109[3]`: また楽しい試合しましょうね！

### 110[]

- `VICTORY_LINES.110[1]`: …相手の癖、途中で読めた。あとは流れに乗っただけ
- `VICTORY_LINES.110[2]`: 試合って、組んでみて初めて見えてくることがあるよね
- `VICTORY_LINES.110[3]`: …悪くなかった。うん

### 111[]

- `VICTORY_LINES.111[1]`: …悪くない勝ち方だったかな
- `VICTORY_LINES.111[2]`: ライバルがいるから強くなれる。次もよろしくねっ
- `VICTORY_LINES.111[3]`: 負けず嫌いは損な性分だけどさ、こういう時だけは役に立つね

### 112[]

- `VICTORY_LINES.112[1]`: あ……勝てた。あの、見ててくれましたか？
- `VICTORY_LINES.112[2]`: ちょっと震えてましたけど、最後は思い切りやれました
- `VICTORY_LINES.112[3]`: ありがとうございます……！また応援してください

### 113[]

- `VICTORY_LINES.113[1]`: ……勝ちました
- `VICTORY_LINES.113[2]`: ……打ち込むのは、好きです
- `VICTORY_LINES.113[3]`: ……また、やります

### 114[]

- `VICTORY_LINES.114[1]`: 当然だよ。負けるわけないじゃん
- `VICTORY_LINES.114[2]`: 組み合ったら、絶対に離さない。そういう気持ちが良く働いたかも
- `VICTORY_LINES.114[3]`: 負けず嫌い結構。事実、負けてないからね

### 115[]

- `VICTORY_LINES.115[1]`: わたしの技もちゃんと通用するものね
- `VICTORY_LINES.115[2]`: 一つの技に何通りも仕掛けがあるんです。丁寧に覚えました
- `VICTORY_LINES.115[3]`: 真面目に続けてきて、よかったと心から思います

### 116[]

- `VICTORY_LINES.116[1]`: Yeah！最高な試合だったね！
- `VICTORY_LINES.116[2]`: リングって、仲間がいてこそだと思う。ありがとね
- `VICTORY_LINES.116[3]`: また一緒に盛り上げよう！

### 117[]

- `VICTORY_LINES.117[1]`: 次はどいつだ。全員やってやる
- `VICTORY_LINES.117[2]`: あぁ？こんなもんかよ。もっと手応えのあるやつ連れてこい
- `VICTORY_LINES.117[3]`: 強えやつが一番。それだけだろうが

### 118[]

- `VICTORY_LINES.118[1]`: …ねえ、まだ動けるの？ どこ壊したら諦めるか、もう覚えたんだけど。
- `VICTORY_LINES.118[2]`: 関節ってさ、一回外れると元には戻らないのよね。覚えといて。
- `VICTORY_LINES.118[3]`: 次も同じとこ狙うから。

### 119[]

- `VICTORY_LINES.119[1]`: この一勝のために、どれほどの練習を積んできたか……
- `VICTORY_LINES.119[2]`: 打撃は誤魔化しが効かない分野ですわ。研鑽が直接結果に出るから、好きなのですわ
- `VICTORY_LINES.119[3]`: まだまだですけれど、少し良くなったかしら？

### 120[]

- `VICTORY_LINES.120[1]`: あらあら、うまくいきましたわね
- `VICTORY_LINES.120[2]`: ねじ伏せるというのは、ちょっと品が無いかしら。と思いつつも癖になってしまって
- `VICTORY_LINES.120[3]`: みなさま、楽しんでいただけましたか？

### 121[]

- `VICTORY_LINES.121[1]`: ふふ…あら、終わり? もう少し遊べると思ったのに
- `VICTORY_LINES.121[2]`: 勝てると思った？私はそんなに柔じゃないのよ
- `VICTORY_LINES.121[3]`: 打ち合いは好きよ。気持ちの強いほうが勝つしねっ

### 122[]

- `VICTORY_LINES.122[1]`: …勝った
- `VICTORY_LINES.122[2]`: …負けなくて良かった。
- `VICTORY_LINES.122[3]`: …言葉は、いらない

### 123[]

- `VICTORY_LINES.123[1]`: あの瞬間、何が刺さるか見えた
- `VICTORY_LINES.123[2]`: 流れを読んで合わせる。それだけ
- `VICTORY_LINES.123[3]`: 次も同じ相手なら、また変える

### 124[]

- `VICTORY_LINES.124[1]`: …いい試合だったね。お互い全力を出せたと思う
- `VICTORY_LINES.124[2]`: ライバルがいてこそ、私は強くなれる
- `VICTORY_LINES.124[3]`: 真面目に打ち込んだのが報われるって、こういうことだね

### 125[]

- `VICTORY_LINES.125[1]`: あはは、勝っちゃったね。どうも、どうも
- `VICTORY_LINES.125[2]`: ん？試合が楽しいからやってるんだよ。単純でしょ
- `VICTORY_LINES.125[3]`: みんなが笑ってるのが一番。でも勝てるともっと嬉しいね

### 126[]

- `VICTORY_LINES.126[1]`: ……努力が、ちゃんと形になってくれた
- `VICTORY_LINES.126[2]`: 地味なことしか、してないんだけどね。それでいいと思ってるから
- `VICTORY_LINES.126[3]`: ……また、やるよ

### 127[]

- `VICTORY_LINES.127[1]`: コツコツ続けてきて、本当によかったです
- `VICTORY_LINES.127[2]`: 練習通りの力を出せました。それに成果が付いてきたという事ですね
- `VICTORY_LINES.127[3]`: タイトなスケジュールの中でも効率的な練習を積み上げれば、これくらいはできるんですよ？

### 128[]

- `VICTORY_LINES.128[1]`: あら、もう落ちたの? 物足りないわね
- `VICTORY_LINES.128[2]`: あらあら。情けなく伸びたその顔♪無様ねぇ♪
- `VICTORY_LINES.128[3]`: わたしに逆らう子は、まとめて折ってあげる
...
- `DAMAGE_VOICE_LINES.polite[1]`: きゃっ…！
- `DAMAGE_VOICE_LINES.polite[2]`: あっ…！
- `DAMAGE_VOICE_LINES.polite[3]`: うぅっ…！
- `DAMAGE_VOICE_LINES.polite[4]`: ひっ…！

### seductive[]

- `DAMAGE_VOICE_LINES.seductive[1]`: あぁんっ…！
- `DAMAGE_VOICE_LINES.seductive[2]`: んっ…！
- `DAMAGE_VOICE_LINES.seductive[3]`: くぅ…っ！
- `DAMAGE_VOICE_LINES.seductive[4]`: はぁ…っ！

### delinquent[]

- `DAMAGE_VOICE_LINES.delinquent[1]`: ぐはっ…！
- `DAMAGE_VOICE_LINES.delinquent[2]`: がっ…！
- `DAMAGE_VOICE_LINES.delinquent[3]`: くそっ…！
- `DAMAGE_VOICE_LINES.delinquent[4]`: うあっ…！

### ojousama[]

- `DAMAGE_VOICE_LINES.ojousama[1]`: きゃあっ…！
- `DAMAGE_VOICE_LINES.ojousama[2]`: あっ…！
- `DAMAGE_VOICE_LINES.ojousama[3]`: うぅっ…！
- `DAMAGE_VOICE_LINES.ojousama[4]`: ああっ…！

### cool[]

- `DAMAGE_VOICE_LINES.cool[1]`: …っ！
- `DAMAGE_VOICE_LINES.cool[2]`: ……っ
- `DAMAGE_VOICE_LINES.cool[3]`: …くっ
- `DAMAGE_VOICE_LINES.cool[4]`: …っ…

### composed[]

- `DAMAGE_VOICE_LINES.composed[1]`: …っ
- `DAMAGE_VOICE_LINES.composed[2]`: ふ…っ
- `DAMAGE_VOICE_LINES.composed[3]`: …くっ
- `DAMAGE_VOICE_LINES.composed[4]`: …はぁ…っ
...
- 出典: `src/battle-engine-main.js`
- コード内コメント: FINISH_SUSPENSE / フィニッシュクリックボックス表示中の実況テキストプール。{d}=被攻撃者名
- 本数: 17

### fall[]

- `FINISH_SUSPENSE.fall[1]`: 入ったか…！？ スリーカウントなるかーーーっ！！
- `FINISH_SUSPENSE.fall[2]`: カウントツー！ 返せるのか！？ 返せないのか！？
- `FINISH_SUSPENSE.fall[3]`: 万事休すか…！ {d}、ここが正念場だーっ！
- `FINISH_SUSPENSE.fall[4]`: このまま決まってしまうのか…！！
- `FINISH_SUSPENSE.fall[5]`: 会場が息を飲んでいる…！ {d}の運命やいかにーーっ！

### gu[]

- `FINISH_SUSPENSE.gu[1]`: タップするのか…！？ しないのか…！？
- `FINISH_SUSPENSE.gu[2]`: ロープに手が届くか…！ {d}、必死に腕を伸ばす…！！
- `FINISH_SUSPENSE.gu[3]`: {d}の表情が…！ 耐えられるのか！？
- `FINISH_SUSPENSE.gu[4]`: レフェリーが確認している…！ ギブアップか…！？
- `FINISH_SUSPENSE.gu[5]`: 極まっている…！ {d}、絶体絶命だーーっ！

### rollup[]

- `FINISH_SUSPENSE.rollup[1]`: まさかの丸め込み…！ これで決まるのか！？

### pin[]

- `FINISH_SUSPENSE.pin[1]`: フォールだ！ 返せるか…！？ カウント…！！
- `FINISH_SUSPENSE.pin[2]`: 大技の後のカバー！ {d}、肩を上げられるか…！？
- `FINISH_SUSPENSE.pin[3]`: ここで勝負を決めに来た！ {d}の運命は…！！

### tko[]

- `FINISH_SUSPENSE.tko[1]`: もう立ち上がれない…！ レフェリーが試合を見ている！
- `FINISH_SUSPENSE.tko[2]`: 意識が飛んでいる…！ TKOか！？
- `FINISH_SUSPENSE.tko[3]`: これ以上は危険だ！ ストップがかかるか！？
...
- `FAN_EXPECT_REACTIONS.goodCrowd[1]`: これが見たかったんだよ！ 最高の試合だった！
- `FAN_EXPECT_REACTIONS.goodCrowd[2]`: 期待通り…いや、期待以上の名勝負だった！
- `FAN_EXPECT_REACTIONS.goodCrowd[3]`: 会場が一つになった瞬間だった…！
- `FAN_EXPECT_REACTIONS.goodCrowd[4]`: ファンの声が選手に届いた試合だった
- `FAN_EXPECT_REACTIONS.goodCrowd[5]`: 歴史に残るカードを実現してくれた！

### badCrowd[]

- `FAN_EXPECT_REACTIONS.badCrowd[1]`: もう少し噛み合ってほしかった…
- `FAN_EXPECT_REACTIONS.badCrowd[2]`: 期待が大きすぎたのかもしれない
