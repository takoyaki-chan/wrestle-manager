...
- `AWARD_LINES.hofCoach._default[2]`: 最初に会った頃は不安だらけだったのに…立派になって…。
- `AWARD_LINES.hofCoach._default[3]`: 殿堂入りか…私が教えたなかで一番の誇りだよ。
- `AWARD_LINES.hofCoach._default[4]`: この日を見届けられて、コーチ冥利に尽きます。
- `AWARD_LINES.hofCoach._default[5]`: あの子の努力を誰より知っている。おめでとう。

## `MILESTONE_EVENTS`

- 出典: `src/data.js`
- コード内コメント: ╔══════════════════════════════════════════════════════════╗ / ║  SECTION 9: MILESTONE EVENTS (v1.5s25b)                  ║ / ╚══════════════════════════════════════════════════════════╝
- 本数: 51

### [].title

- `MILESTONE_EVENTS[1].title`: 🎉 旗揚げ興行
- `MILESTONE_EVENTS[2].title`: 📰 地元で話題に
- `MILESTONE_EVENTS[3].title`: ⚡ 因縁の芽生え

### [].narration

- `MILESTONE_EVENTS[1].narration`: 記念すべき第一回興行が幕を閉じた。⏎観客はまばらだったが、選手たちの目は確かに輝いていた。⏎この先、団体をどう導いていくか——
- `MILESTONE_EVENTS[2].narration`: 地元のスポーツ紙に団体の名前が載った。⏎「あそこの興行、最近面白いらしいよ」⏎——そんな声がちらほら聞こえ始めている。

### [].choices[].label

- `MILESTONE_EVENTS[1].choices[1].label`: 🏠 地元を地道に固めていく
- `MILESTONE_EVENTS[1].choices[2].label`: 💪 選手の育成に力を入れる
- `MILESTONE_EVENTS[1].choices[3].label`: 📣 とにかく知名度を上げたい
- `MILESTONE_EVENTS[2].choices[1].label`: 🤝 ファンとの距離を縮める
- `MILESTONE_EVENTS[2].choices[2].label`: 🎯 試合の質をもっと高める
- `MILESTONE_EVENTS[2].choices[3].label`: 🔍 新戦力の獲得を急ぐ
- `MILESTONE_EVENTS[3].choices[1].label`: 🔥 この対決をじっくり育てる
- `MILESTONE_EVENTS[3].choices[2].label`: ⚔️ 熱いうちに大一番を組む
- `MILESTONE_EVENTS[3].choices[3].label`: 🌐 他の組み合わせも試したい

### [].choices[].result

- `MILESTONE_EVENTS[1].choices[1].result`: 地元の商店街が応援してくれることになった。
- `MILESTONE_EVENTS[1].choices[2].result`: 選手たちの練習に、一層の熱が入り始めた。
- `MILESTONE_EVENTS[1].choices[3].result`: チラシ配りにSNS、できることは全部やった。⏎噂が少しずつ広がり始めている。
- `MILESTONE_EVENTS[2].choices[1].result`: ファン感謝デーを開催した。常連ファンの顔が少しずつ見えてきた。
- `MILESTONE_EVENTS[2].choices[2].result`: 練習メニューを見直し、試合構成にもこだわり始めた。
- `MILESTONE_EVENTS[2].choices[3].result`: 業界に顔が利く人物から、有望な選手の情報が入ってきた。
- `MILESTONE_EVENTS[3].choices[1].result`: ふたりの視線がリング上で交差するたび、会場の空気が変わる。
- `MILESTONE_EVENTS[3].choices[2].result`: 次の対戦が、特別な一戦になる予感がする。
- `MILESTONE_EVENTS[3].choices[3].result`: いろんな選手をぶつけてみよう。化学反応はどこで起きるか分からない。

### [].choices[].effectLabel

- `MILESTONE_EVENTS[1].choices[1].effectLabel`: 補助金+40万/週（3週間）
- `MILESTONE_EVENTS[1].choices[2].effectLabel`: 練習効率×1.5（4週間）
- `MILESTONE_EVENTS[1].choices[3].effectLabel`: 次2興行の集客×1.3
- `MILESTONE_EVENTS[2].choices[1].effectLabel`: プロモ効果+1（4週間）
- `MILESTONE_EVENTS[2].choices[2].effectLabel`: 全試合MQ+3、集客×1.15（4週間）
- `MILESTONE_EVENTS[2].choices[3].effectLabel`: 次のFA獲得費用-30%
- `MILESTONE_EVENTS[3].choices[1].effectLabel`: 因縁カウント+1
- `MILESTONE_EVENTS[3].choices[2].effectLabel`: 次の対戦MQ+3、その興行の集客×1.20
- `MILESTONE_EVENTS[3].choices[3].effectLabel`: 因縁成立しやすくなる（3週間）

### [].titleMain

- `MILESTONE_EVENTS[4].titleMain`: 到 　 達
- `MILESTONE_EVENTS[5].titleMain`: 満 　 員

### [].titleSub

- `MILESTONE_EVENTS[4].titleSub`: THE DOME
- `MILESTONE_EVENTS[5].titleSub`: FULL HOUSE

### [].narration[]

- `MILESTONE_EVENTS[4].narration[1]`: ドーム。
- `MILESTONE_EVENTS[4].narration[2]`: 日本のプロレス界で、頂点を意味する三文字。
- `MILESTONE_EVENTS[4].narration[3]`: この会場に名を刻むことは、団体にとって一つの到達点であり、
- `MILESTONE_EVENTS[4].narration[4]`: 同時に、新たな始まりでもある。
- `MILESTONE_EVENTS[4].narration[5]`: 控室のドアの前で、一度立ち止まった。
- `MILESTONE_EVENTS[4].narration[6]`: 息を整え、扉を開ける。
- `MILESTONE_EVENTS[4].narration[7]`: ——選手たちが、待っている。
- `MILESTONE_EVENTS[5].narration[1]`: 満員のドーム。
- `MILESTONE_EVENTS[5].narration[2]`: かつて、日本のプロレス興行における最大の到達点とされてきた景色。
- `MILESTONE_EVENTS[5].narration[3]`: 三万の観客席のすべてが埋まり、彼らは今、この団体の名を呼んでいる。
- `MILESTONE_EVENTS[5].narration[4]`: 最終試合の鐘が鳴り、選手たちがリングから引き上げる。
- `MILESTONE_EVENTS[5].narration[5]`: 照明が落ち、客電が灯っても——
- `MILESTONE_EVENTS[5].narration[6]`: 拍手は、しばらく鳴り止まなかった。

### [].continueLabel

- `MILESTONE_EVENTS[4].continueLabel`: 試 合 に 向 か う
- `MILESTONE_EVENTS[5].continueLabel`: 控 室 へ 戻 る
...
- `Engine.awards._EPITHET_TEMPLATES.undefeatedReign[1]`: 無敗の女王
- `Engine.awards._EPITHET_TEMPLATES.undefeatedReign[2]`: 不敗伝説
- `Engine.awards._EPITHET_TEMPLATES.undefeatedReign[3]`: 無傷の戴冠者
- `Engine.awards._EPITHET_TEMPLATES.undefeatedReign[4]`: 負け知らずの王者

### 20Defense[]

- `Engine.awards._EPITHET_TEMPLATES.20Defense[1]`: 絶対王者
- `Engine.awards._EPITHET_TEMPLATES.20Defense[2]`: 防衛ロードの怪物
- `Engine.awards._EPITHET_TEMPLATES.20Defense[3]`: {n}人切り
- `Engine.awards._EPITHET_TEMPLATES.20Defense[4]`: 生ける要塞
- `Engine.awards._EPITHET_TEMPLATES.20Defense[5]`: 不落の王座

### grandSlam[]

- `Engine.awards._EPITHET_TEMPLATES.grandSlam[1]`: 完全制覇の女帝
- `Engine.awards._EPITHET_TEMPLATES.grandSlam[2]`: 全冠の覇者
- `Engine.awards._EPITHET_TEMPLATES.grandSlam[3]`: グランドスラム・クイーン
- `Engine.awards._EPITHET_TEMPLATES.grandSlam[4]`: 歴史を塗り替えた女

### juniorConsecutive3[]

- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive3[1]`: 世代の悪夢
- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive3[2]`: 三年王朝
- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive3[3]`: ジュニアの独裁者
- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive3[4]`: 三連覇の怪物

### ppvConsecutive2[]

- `Engine.awards._EPITHET_TEMPLATES.ppvConsecutive2[1]`: 大舞台の女王
- `Engine.awards._EPITHET_TEMPLATES.ppvConsecutive2[2]`: 連覇の記憶
- `Engine.awards._EPITHET_TEMPLATES.ppvConsecutive2[3]`: グランドファイナルの支配者
- `Engine.awards._EPITHET_TEMPLATES.ppvConsecutive2[4]`: ファイナルの主役

### mvp3plus[]

- `Engine.awards._EPITHET_TEMPLATES.mvp3plus[1]`: 殿堂級MVP
- `Engine.awards._EPITHET_TEMPLATES.mvp3plus[2]`: 三度の栄冠
- `Engine.awards._EPITHET_TEMPLATES.mvp3plus[3]`: 時代の主人公
- `Engine.awards._EPITHET_TEMPLATES.mvp3plus[4]`: 永遠のMVP
- `Engine.awards._EPITHET_TEMPLATES.mvp3plus[5]`: 栄光の常連

### 15Defense[]

- `Engine.awards._EPITHET_TEMPLATES.15Defense[1]`: 無敵の長期政権
- `Engine.awards._EPITHET_TEMPLATES.15Defense[2]`: 鉄壁の女王
- `Engine.awards._EPITHET_TEMPLATES.15Defense[3]`: 終わらない治世
- `Engine.awards._EPITHET_TEMPLATES.15Defense[4]`: 防衛街道の果てに

### tripleChamp[]

- `Engine.awards._EPITHET_TEMPLATES.tripleChamp[1]`: 不死鳥
- `Engine.awards._EPITHET_TEMPLATES.tripleChamp[2]`: 返り咲きの女王
- `Engine.awards._EPITHET_TEMPLATES.tripleChamp[3]`: 三度の頂
- `Engine.awards._EPITHET_TEMPLATES.tripleChamp[4]`: 不滅の王者

### juniorConsecutive2[]

- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive2[1]`: ジュニアの覇者
- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive2[2]`: 二連覇の衝撃
- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive2[3]`: 連覇を刻んだ新星
- `Engine.awards._EPITHET_TEMPLATES.juniorConsecutive2[4]`: 世代を二度制した女

### ppvDouble[]

- `Engine.awards._EPITHET_TEMPLATES.ppvDouble[1]`: 大舞台の主
- `Engine.awards._EPITHET_TEMPLATES.ppvDouble[2]`: PPVの申し子
- `Engine.awards._EPITHET_TEMPLATES.ppvDouble[3]`: 決戦のスペシャリスト

### 10Defense[]

- `Engine.awards._EPITHET_TEMPLATES.10Defense[1]`: 堅牢なる王者
- `Engine.awards._EPITHET_TEMPLATES.10Defense[2]`: 王座の番人
- `Engine.awards._EPITHET_TEMPLATES.10Defense[3]`: 鉄の防衛線

### mvp2[]

- `Engine.awards._EPITHET_TEMPLATES.mvp2[1]`: 団体の顔
- `Engine.awards._EPITHET_TEMPLATES.mvp2[2]`: 二度の最優秀
- `Engine.awards._EPITHET_TEMPLATES.mvp2[3]`: MVP二冠
- `Engine.awards._EPITHET_TEMPLATES.mvp2[4]`: 時代のエース

### bestMatch3plus[]

- `Engine.awards._EPITHET_TEMPLATES.bestMatch3plus[1]`: 試合の天才
- `Engine.awards._EPITHET_TEMPLATES.bestMatch3plus[2]`: 名勝負の女神
- `Engine.awards._EPITHET_TEMPLATES.bestMatch3plus[3]`: 黄金のカード
- `Engine.awards._EPITHET_TEMPLATES.bestMatch3plus[4]`: 好勝負請負人

### warAce[]

- `Engine.awards._EPITHET_TEMPLATES.warAce[1]`: 対抗戦の英雄
- `Engine.awards._EPITHET_TEMPLATES.warAce[2]`: 団体の切り札
- `Engine.awards._EPITHET_TEMPLATES.warAce[3]`: 対抗戦の鬼
- `Engine.awards._EPITHET_TEMPLATES.warAce[4]`: エースキラー

### titleDefender[]

- `Engine.awards._EPITHET_TEMPLATES.titleDefender[1]`: 名王者
- `Engine.awards._EPITHET_TEMPLATES.titleDefender[2]`: 堅実なる戴冠者
- `Engine.awards._EPITHET_TEMPLATES.titleDefender[3]`: 守りの女王
- `Engine.awards._EPITHET_TEMPLATES.titleDefender[4]`: 実力派チャンピオン

### juniorChamp[]

- `Engine.awards._EPITHET_TEMPLATES.juniorChamp[1]`: ジュニアの星
- `Engine.awards._EPITHET_TEMPLATES.juniorChamp[2]`: 登竜門の覇者
- `Engine.awards._EPITHET_TEMPLATES.juniorChamp[3]`: トーナメント・ウィナー

### ppvChamp[]

- `Engine.awards._EPITHET_TEMPLATES.ppvChamp[1]`: 大舞台の勝者
- `Engine.awards._EPITHET_TEMPLATES.ppvChamp[2]`: 年末の主人公
- `Engine.awards._EPITHET_TEMPLATES.ppvChamp[3]`: PPVの記憶
- `Engine.awards._EPITHET_TEMPLATES.ppvChamp[4]`: グランドファイナリスト

### mvp1[]

- `Engine.awards._EPITHET_TEMPLATES.mvp1[2]`: 年間最優秀選手
- `Engine.awards._EPITHET_TEMPLATES.mvp1[3]`: その年の顔
- `Engine.awards._EPITHET_TEMPLATES.mvp1[4]`: 一年の主役

### doubleChamp[]

- `Engine.awards._EPITHET_TEMPLATES.doubleChamp[1]`: 二度の戴冠
- `Engine.awards._EPITHET_TEMPLATES.doubleChamp[2]`: 復活王者
- `Engine.awards._EPITHET_TEMPLATES.doubleChamp[3]`: リターン・クイーン
- `Engine.awards._EPITHET_TEMPLATES.doubleChamp[4]`: 捲土重来

### bestMatch1[]

- `Engine.awards._EPITHET_TEMPLATES.bestMatch1[1]`: ベストバウトの主役
- `Engine.awards._EPITHET_TEMPLATES.bestMatch1[2]`: 一戦の輝き
- `Engine.awards._EPITHET_TEMPLATES.bestMatch1[3]`: ベストバウト・アーティスト

### titleHolder[]

- `Engine.awards._EPITHET_TEMPLATES.titleHolder[1]`: 戴冠の記憶
- `Engine.awards._EPITHET_TEMPLATES.titleHolder[2]`: 流星のチャンピオン
- `Engine.awards._EPITHET_TEMPLATES.titleHolder[3]`: ワンチャンス・クイーン

### rookieOfYear[]

- `Engine.awards._EPITHET_TEMPLATES.rookieOfYear[1]`: 新人王
- `Engine.awards._EPITHET_TEMPLATES.rookieOfYear[2]`: デビューイヤーの主役

### peakOvr90[]

- `Engine.awards._EPITHET_TEMPLATES.peakOvr90[1]`: 超一流の証
- `Engine.awards._EPITHET_TEMPLATES.peakOvr90[2]`: 天賦の才
- `Engine.awards._EPITHET_TEMPLATES.peakOvr90[3]`: 覚醒者

### warHero[]

- `Engine.awards._EPITHET_TEMPLATES.warHero[1]`: 対抗戦の功労者
- `Engine.awards._EPITHET_TEMPLATES.warHero[2]`: 団体間抗争の主役
- `Engine.awards._EPITHET_TEMPLATES.warHero[3]`: 抗争の立役者

### mediaAward[]

- `Engine.awards._EPITHET_TEMPLATES.mediaAward[1]`: メディアのチャンピオン
- `Engine.awards._EPITHET_TEMPLATES.mediaAward[2]`: 広報の星
- `Engine.awards._EPITHET_TEMPLATES.mediaAward[3]`: リング外のMVP
- `Engine.awards._EPITHET_TEMPLATES.mediaAward[4]`: メディアの寵児
- `Engine.awards._EPITHET_TEMPLATES.mediaAward[5]`: 話題の中心

### ironwoman[]

- `Engine.awards._EPITHET_TEMPLATES.ironwoman[1]`: 鉄人
- `Engine.awards._EPITHET_TEMPLATES.ironwoman[2]`: 生涯現役
- `Engine.awards._EPITHET_TEMPLATES.ironwoman[3]`: 10年選手

### peakOvr80[]

- `Engine.awards._EPITHET_TEMPLATES.peakOvr80[1]`: 実力者
- `Engine.awards._EPITHET_TEMPLATES.peakOvr80[2]`: 隠れた実力派
- `Engine.awards._EPITHET_TEMPLATES.peakOvr80[3]`: いぶし銀

### bestMQ70[]

- `Engine.awards._EPITHET_TEMPLATES.bestMQ70[1]`: 試合巧者
- `Engine.awards._EPITHET_TEMPLATES.bestMQ70[2]`: 技巧派

### highTrust[]

- `Engine.awards._EPITHET_TEMPLATES.highTrust[1]`: 愛された女
- `Engine.awards._EPITHET_TEMPLATES.highTrust[2]`: ファンの心

### solidCareer[]

- `Engine.awards._EPITHET_TEMPLATES.solidCareer[1]`: 殿堂の誇り
- `Engine.awards._EPITHET_TEMPLATES.solidCareer[2]`: 確かな足跡
- `Engine.awards._EPITHET_TEMPLATES.solidCareer[3]`: 静かなる功労者
- `Engine.awards._EPITHET_TEMPLATES.solidCareer[4]`: 忘れてはならない選手
- `Engine.awards._EPITHET_TEMPLATES.solidCareer[5]`: 名脇役の勲章
- `Engine.awards._EPITHET_TEMPLATES.solidCareer[6]`: リングに生きた女
- `Engine.awards._EPITHET_TEMPLATES.solidCareer[7]`: 縁の下の力持ち
- `Engine.awards._EPITHET_TEMPLATES.solidCareer[8]`: 無冠の実力者
