...
3. ~~セル見出しの選手名EN表記のうち **† は「要読み確認」**~~ → **2026-09-06 の読み裁定で49名すべて確定**(`docs/en-proper-nouns-draft-v0.1.md` 冒頭)。本稿の綴りは裁定後のもの(澤出=**Sawaide** / 橘玲美=**Reimi** / 木ノ内=**Sachine**)に一致しているため、† は撤去した(2026-09-07・内部レビュー⑤)
